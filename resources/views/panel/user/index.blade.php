            ...
            <div class="col-lg-12">
                <div class="card shade h-100">
                    <div class="card-body">
                        ...
                        <a href="{{ route('panel.user.create') }}" class="arrow-none btn btn-primary text-white" aria-expanded="false">
                            ساخت کاربر جدید
                        </a>
                    </div>
                                        ...
                                        <td>
                                            <ul style="list-style: none;">
                                                @foreach ($user->roles as $role)
                                                    ...
                                                    action="{{ route('panel.user.role-remove', ['userId' => $user->id, 'roleId' => $role->id]) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                @endforeach
...
{{--                                                <a href="{{ route('users.edit', $user->id) }}" class="btn btn-danger ml-1">حذف</a>--}}
                                                ...
                                                <a href="{{ route('panel.user.add-roles', $user->id) }}" class="btn btn-success ml-1">

<div class="container-fluid side-bar-container ">
    ...
    <li class="side a-collapse short m-2 pr-1 pl-1">
        <a href="{{ route('it-city.home') }}" class="side-item selected c-dark "><i class="fas fa-language  mr-1"></i>آیتی سیتی
            <span
                class="badge badge-pill badge-success">اسمبل</span></a>
    </li>
    <li class="side a-collapse short m-2 pr-1 pl-1">
        <a href="{{ route('digital-world.technology.index') }}" class="side-item selected c-dark "><i class="fas fa-language  mr-1"></i>دنیای دیجیتالی
            <span
    ...
    <ul class="side a-collapse short">
        ...
        <div class="side-item-container hide animated">
            ...
            <li class="side-item"><a href="./typo.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>تایپوکرافی</a>
            </li>
    ...
    <li class="side a-collapse short ">
        <a href="{{ route('panel.reports.charts.sales') }}" class="side-item "><i class="fas fa-fan fa-spin mr-1"></i>نمودار فروش</a>
    </li>

    <p class="side-comment fnt-mxs">پی سی پارت پیک</p>
    <ul class="side a-collapse short">
        <a class="ul-text fnt-mxs"><i class="fas fa-layer-group mr-1"></i>سیستم اسمبل هوشمند
        ...
        <div class="side-item-container hide animated">
            ...
            <li class="side-item"><a href="./widget.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>Widget</a>
            </li>
    ...
    <ul class="side a-collapse short ">
        ...
        <div class="side-item-container hide animated">
            ...
            <li class="side-item"><a href="./breadcrumb.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>Breadcrumb</a>
            </li>
            <li class="side-item"><a href="./button.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>Button</a>
            </li>
            <li class="side-item"><a href="./card.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>Card</a>
            </li>
            <li class="side-item"><a href="./collapse.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>Collapse</a>
            </li>
            <li class="side-item"><a href="./Input.html" class="fnt-mxs"><i
                        class="fas fa-angle-right mr-2"></i>Input</a></li>
            <li class="side-item"><a href="./jumborton.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>Jumborton</a>
            </li>
            <li class="side-item"><a href="./pagination.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>Pagination</a>
            </li>
            <li class="side-item"><a href="./progress.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>Progress</a>
            </li>
        </div>
    </ul>
    <ul class="side a-collapse short">
    ...
    <li class="side a-collapse short pb-5">
        <a href="https://donateon.ir/alinejad.mj" class="side-item  fnt-mxs "><i class=" fas fa-coffee mr-1"></i>کمک به
            توسعه دهنده </a>
    </li>
</div>

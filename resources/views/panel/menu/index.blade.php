            ...
            <div class="col-lg-12">
                <div class="card shade h-100">
                    <div class="card-body">
                        ...
                        <a href="{{ route('panel.menu.create') }}" class="arrow-none btn btn-primary text-white" aria-expanded="false">
                            ساخت منوی جدید
                        </a>
                    </div>
                            ...
                            <tbody>
                                @foreach($menus as $menu)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="row">
                                                <a href="{{ route('panel.menu.edit', $menu->id) }}" class="btn btn-warning">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form action="{{ route('panel.menu.change.status', $menu->id) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="{{ route('panel.menu.destroy', $menu->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')

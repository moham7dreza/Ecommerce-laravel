                ...
                <div class="card shade h-100">
                    <div class="card-body">
                        <div class="float-left cart-title">
                            <a href="{{ route('panel.market.category.create') }}" class="btn main f-main btn-block fnt-xs" aria-expanded="false">
                                ساخت دسته بندی جدید
                            </a>
                        </div>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                @foreach($categories as $category)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="row">
                                                <a href="{{ route('panel.market.category.edit', $category->id) }}" class="btn outlined c-main o-main fnt-xxs ml-1">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form action="{{ route('panel.market.category.change.status', $category->id) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="{{ route('panel.market.category.destroy', $category->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')

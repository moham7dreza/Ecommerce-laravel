            ...
            <div class="col-lg-12">
                <div class="card shade h-100">
                    <div class="card-body">
                        ...
                        <a href="{{ route('panel.post.create') }}" class="arrow-none btn btn-primary text-white" aria-expanded="false">
                            ساخت پست جدید
                        </a>
                    </div>
                            ...
                            <tbody>
                                @foreach($posts as $post)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="row">
                                                <a href="{{ route('panel.post.edit', $post->id) }}" class="btn btn-warning">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form action="{{ route('panel.post.change.status', $post->id) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')

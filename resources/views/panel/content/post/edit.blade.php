            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('adminto.post.update', $post->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            value="{{ old('time_to_read', $post->time_to_read) }}" id="time_to_read" name="time_to_read"
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('status') is-invalid @enderror" name="status">
                                                @foreach (\App\Models\Content\Post::$statuses as $status)
                                                    <option @if (old('status', $post->status) === $status) selected @endif
                                                        value="{{ $status }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('summary') is-invalid @enderror"
                                                   value="{{ old('summary', $post->summary) }}" id="summary" name="summary">
                                            @error('summary')
                                            <br>
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror

        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.smart-assemble.system.gallery.create', $system) }}"
                        ...
                        @foreach ($system->images as $image)
                            ...
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    <form class="d-inline"
                                          action="{{ route('admin.smart-assemble.system.gallery.destroy', ['system' => $system , 'systemGallery' => $image] ) }}"
                                          method="post">
                                        @csrf
                                        {{ method_field('delete') }}

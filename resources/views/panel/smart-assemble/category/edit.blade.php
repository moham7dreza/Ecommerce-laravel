  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.smart-assemble.category.update', $systemCategory->id) }}" method="post" enctype="multipart/form-data" id="form">
                    @csrf
                    @method('PUT')
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name', $systemCategory->name) }}" class="form-control form-control-sm">
                            </div>
                            @error('name')
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="parent_id" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="{{ $parent_category->id }}"  @if(old('parent_id', $systemCategory->parent_id) == $parent_category->id) selected @endif>{{ $parent_category->name }}</option>
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="brief" value="{{ old('brief', $systemCategory->brief) }}" class="form-control form-control-sm">
                            </div>
                            @error('brief')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
                        ...
                        <section class="row">
                            ...
                            <section class="col-md-{{ 6 / $number }}">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" name="currentImage" value="{{ $key }}" id="{{ $number }}" @if($systemCategory->image['currentImage'] == $key) checked @endif>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="form-control form-control-sm" id="status">
                                    <option value="0" @if (old('status', $systemCategory->status) == 0) selected @endif>غیرفعال</option>
                                    <option value="1" @if (old('status', $systemCategory->status) == 1) selected @endif>فعال</option>
                                </select>
                            </div>
                            @error('status')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="show_in_menu" id="" class="form-control form-control-sm" id="show_in_menu">
                                    <option value="0" @if (old('show_in_menu', $systemCategory->show_in_menu) == 0) selected @endif>غیرفعال</option>
                                    <option value="1" @if (old('show_in_menu', $systemCategory->show_in_menu) == 1) selected @endif>فعال</option>
                                </select>
                            </div>
                            @error('show_in_menu')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">

    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('admin.smart-assemble.brand.create') }}" class="btn btn-info btn-sm">ایجاد برند </a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.smart-assemble.brand.edit', $brand->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
                                <form class="d-inline" action="{{ route('admin.smart-assemble.brand.destroy', $brand->id) }}" method="post">
                                    @csrf
                                    {{ method_field('delete') }}

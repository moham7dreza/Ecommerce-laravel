...
{{--                                        <td>{{ jdate($comment->created_at)->format('Y-m-d') }}</td>--}}
                                        ...
                                        <td>
                                            <div class="row">
                                                <form action="{{ route('panel.office.comment.change.status', $comment->id) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="{{ route('panel.office.comment.change.approve', $comment->id) }}" method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="{{ route('panel.office.comment.destroy', $comment->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')

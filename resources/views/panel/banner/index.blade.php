                ...
                <div class="card shade h-100">
                    <div class="card-body">
                        <div class="float-left cart-title">
                            <a href="{{ route('panel.banner.create') }}" class="arrow-none btn btn-primary text-white"
                               aria-expanded="false">
                                ساخت تبلیغات جدید
                            </a>
                        </div>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                @foreach($banners as $banner)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="row">
                                                <a href="{{ route('panel.banner.edit', $banner->id) }}"
                                                   class="btn btn-warning">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form action="{{ route('panel.banner.change.status', $banner->id) }}"
                                                      method="POST">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="{{ route('panel.banner.destroy', $banner->id) }}"
                                                      method="POST">
                                                    @csrf
                                                    @method('DELETE')

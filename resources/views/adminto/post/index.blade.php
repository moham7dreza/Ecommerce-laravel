            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="float-right">
                        <a href="{{ route('adminto.post.create') }}" class="arrow-none btn btn-primary text-white"
                           aria-expanded="false">
                            ساخت پست جدید
                        </a>
                    </div>
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            @foreach($posts as $post)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <div class="row">
                                            <a href="{{ route('adminto.post.edit', $post->id) }}"
                                               class="btn btn-warning">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <form action="{{ route('adminto.post.change.status', $post->id) }}"
                                                  method="POST">
                                                @csrf
                                                @method('PATCH')

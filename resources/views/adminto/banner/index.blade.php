            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="float-right">
                        <a href="{{ route('adminto.banner.create') }}" class="arrow-none btn btn-primary text-white"
                           aria-expanded="false">
                            ساخت تبلیغات جدید
                        </a>
                    </div>
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            @foreach($banners as $banner)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <div class="row">
                                            <a href="{{ route('adminto.banner.edit', $banner->id) }}"
                                               class="btn btn-warning">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <form action="{{ route('adminto.banner.change.status', $banner->id) }}"
                                                  method="POST">
                                                @csrf
                                                @method('PATCH')
                                            ...
                                            <form action="{{ route('adminto.banner.destroy', $banner->id) }}"
                                                  method="POST">
                                                @csrf
                                                @method('DELETE')

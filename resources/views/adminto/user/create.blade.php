...
{{--                           <form class="form-horizontal" role="form" method="POST" action="/admin/users"> DONT WRITE THIS FOR ACTION--}}
                                <form class="form-horizontal" role="form" method="POST" action="{{ route('adminto.user.store') }}">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label" for="first_name">نام</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                            value="{{ old('first_name') }}" id="first_name" name="first_name" placeholder="نام کاربر را وارد کنید">
                                            @error('first_name')
                                                <br>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                                   value="{{ old('last_name') }}" id="last_name" name="last_name" placeholder="نام خانوادگی کاربر را وارد کنید">
                                            @error('last_name')
                                            <br>
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control @error('activation') is-invalid @enderror" name="activation">

            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="float-right">
                        <a href="{{ route('adminto.user.create') }}" class="arrow-none btn btn-primary text-white"
                           aria-expanded="false">
                            ساخت کاربر جدید
                        </a>
                    </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <a href="{{ route('adminto.user.edit', $user->id) }}"
                                               class="btn btn-warning">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a href="{{ route('adminto.user.add-roles', $user->id) }}"

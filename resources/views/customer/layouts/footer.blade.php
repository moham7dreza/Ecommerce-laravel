        ...
        <section class="row">
            ...
            <section class="col-md-5">
                <section>
                    ...
                    <section class="my-3">
                        <a href="{{ json_decode($setting->social_media, true)['instagram'] }}"
                           class="text-muted text-decoration-none me-5"><i class="fab fa-instagram"></i></a>
                        <a href="{{ json_decode($setting->social_media, true)['telegram'] }}"
                           class="text-muted text-decoration-none me-5"><i class="fab fa-telegram"></i></a>
                        <a href="{{ json_decode($setting->social_media, true)['whatsapp'] }}"

...
{{--                    <section class="navbar-item"><a href="#">آمازون پلاس</a></section>--}}
                    ...
                    <section class="navbar-item"><a
                            href="{{ route('customer.market.category.products', \App\Models\Market\ProductCategory::find(6)) }}">تست
                            رم</a></section>
                    ...
                    <section class="navbar-item"><a href="{{ route('it-city.pc.smart-assemble.index') }}">آی تی سی تی</a></section>

                                        ...
                                        <section class="product">
                                            @guest
                                                <section class="product-add-to-favorite">
                                                    <button class="btn btn-light btn-sm text-decoration-none" data-url="{{ route('customer.market.add-to-favorite', $activeAmazingSaleProduct) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="اضافه از علاقه مندی">
                                            ...
                                            @auth
                                                ...
                                                @if ($activeAmazingSaleProduct->user->contains(auth()->user()->id))
                                                    <section class="product-add-to-favorite">
                                                        <button class="btn btn-light btn-sm text-decoration-none" data-url="{{ route('customer.market.add-to-favorite', $activeAmazingSaleProduct) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="حذف از علاقه مندی">
                                                            <i class="fa fa-heart text-danger"></i>
                                                        </button>
                                                    </section>
                                                @else
                                                    <section class="product-add-to-favorite">
                                                        <button class="btn btn-light btn-sm text-decoration-none" data-url="{{ route('customer.market.add-to-favorite', $activeAmazingSaleProduct) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="اضافه به علاقه مندی">
                                                            <i class="fa fa-heart"></i>
                                                        </button>
                                                    </section>
                                                @endif
                                            ...
                                            <a class="product-link" href="{{ route('customer.market.product', $activeAmazingSaleProduct) }}">
                                                <section class="product-image">
                                                    <img class="" src="{{ asset($activeAmazingSaleProduct->image['indexArray']['medium']) }}" alt="{{ $activeAmazingSaleProduct->name }}">
                                                </section>
                                                <section class="product-colors"></section>
                                                <section class="product-name"><h3>{{ Str::limit($activeAmazingSaleProduct->name, 30) }}</h3></section>
                                                <section class="product-price-wrapper">
                                                    <section class="product-discount">
                                                        <span class="product-old-price">{{ priceFormat($activeAmazingSaleProduct->price) }} تومان</span>
                                                        <span class="product-discount-amount">% {{ convertEnglishToPersian($amazingSale->percentage) }}</span>
                                                    </section>
            ...
            <section class="row py-4">
                @foreach ($fourColumnBanners as $colBanner)
                    <section class="col">
                        ...
                        <img class="d-block rounded-2 w-100" src="{{ asset($colBanner->image) }}" alt="{{ $colBanner->title }}">
                        </a>
                    </section>
                @endforeach
            </section>
                ...
                <section class="row py-4">
                    <section class="col">
                        <a href="{{ urldecode($brandsBanner->url) }}">
                            <img class="d-block rounded-2 w-100" src="{{ asset($brandsBanner->image) }}" alt="{{ $brandsBanner->title }}">
                        </a>
                    </section>
                </section>

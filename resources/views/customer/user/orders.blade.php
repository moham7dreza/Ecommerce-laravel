            ...
            <main id="main-body" class="main-body col-md-9">
                <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                    ...
                    <section class="d-flex justify-content-center my-4">
                        <a class="btn btn-outline-primary btn-sm mx-1" href="{{ route('user.orders') }}">همه</a>
                        <a class="btn btn-info btn-sm mx-1" href="{{ route('user.orders', 'type=0') }}">بررسی نشده</a>
                        <a class="btn btn-warning btn-sm mx-1" href="{{ route('user.orders', 'type=1') }}">در انتظار
                            تایید</a>
                        <a class="btn btn-success btn-sm mx-1" href="{{ route('user.orders', 'type=2') }}">تایید
                            نشده</a>
                        <a class="btn btn-danger btn-sm mx-1" href="{{ route('user.orders', 'type=3') }}">تایید شده</a>
                        <a class="btn btn-outline-danger btn-sm mx-1" href="{{ route('user.orders', 'type=4') }}">باطل
                            شده</a>
                        <a class="btn btn-dark btn-sm mx-1" href="{{ route('user.orders', 'type=5') }}">مرجوع شده</a>
                    </section>

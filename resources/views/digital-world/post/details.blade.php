        ...
        <div class="container" style="transform: none;">
            <div class="entry-header entry-header-1 mb-30 mt-50">
                <div class="entry-meta meta-0 font-small mb-30">
                    <a href="">
                        <span class="post-cat bg-success color-white">{{ $post->category->name }}</span>
                    </a>
                </div>
                ...
                <div class="entry-meta meta-1 font-x-small color-grey text-uppercase">
                    ...
                    <span class="post-on">تاریخ انتشار : {{ jdate($post->created_at)->format('Y-m-d') }}</span>
                    <span class="time-reading">زمان خواندن {{ $post->time_to_read }} دقیقه</span>
                    <p class="font-x-small mt-10">
                        <span class="hit-count"><i class="ti-comment ml-5"></i>نظرات {{ $post->activeComments()->count() }}</span>
                        ...
                        <div class="author-info">
                            <h3>
                                <span class="vcard author">
                                    <span class="fn">
                                        <a href="author.html" rel="author">{{ $post->author->fullName }}</a>
                                    </span>
                                </span>
                            </h3>
                            <h5 class="text-muted">

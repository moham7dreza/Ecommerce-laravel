<div class="comments-area">
    <h3 class="mb-30">{{ $post->activeComments()->count() }} نظرات</h3>
    @foreach ($post->activeComments()->latest()->get() as $comment)
            ...
            <div class="user justify-content-between d-flex">
                ...
                <div class="desc">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5>
                                <a href="{{ $commentReply->user->path() }}">{{ $commentReply->user->fullName }}</a>
                            </h5>

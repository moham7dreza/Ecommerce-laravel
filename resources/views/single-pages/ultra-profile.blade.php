...
<head>
    ...
    <link href="{{ asset('profile-assets/css/bootstrap-icons.css') }}" rel="stylesheet">

    <link href="{{ asset('profile-assets/css/magnific-popup.css') }}" rel="stylesheet">

    <link href="{{ asset('profile-assets/css/templatemo-first-portfolio-style.css') }}" rel="stylesheet">
...
<script src="{{ asset('profile-assets/js/jquery.sticky.js') }}"></script>
<script src="{{ asset('profile-assets/js/click-scroll.js') }}"></script>
<script src="{{ asset('profile-assets/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('profile-assets/js/magnific-popup-options.js') }}"></script>

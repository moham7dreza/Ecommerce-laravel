...
<head>
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" href="{{ asset('hydrogen-assets/css/animate.css') }}">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="{{ asset('hydrogen-assets/css/icomoon.css') }}">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="{{ asset('hydrogen-assets/css/magnific-popup.css') }}">
    <!-- Salvattore -->
    <link rel="stylesheet" href="{{ asset('hydrogen-assets/css/salvattore.css') }}">
    <!-- Theme Style -->
    <link rel="stylesheet" href="{{ asset('hydrogen-assets/css/style.css') }}">
    <!-- Modernizr JS -->
    <script src="{{ asset('hydrogen-assets/js/modernizr-2.6.2.min.js') }}"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
    <script src="{{ asset('hydrogen-assets/js/respond.min.js') }}"></script>
    <![endif]-->
    ...
    <div class="container">
        <div class="row row-padded">
            <div class="col-md-12 text-center">
                ...
                <p><small>&copy; Hydrogen Free HTML5 Template. All Rights Reserved. <br>Designed by: <a
                            href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a> | Images by: <a
                            href="http://pexels.com" target="_blank">Pexels</a> </small></p>
            </div>
        </div>
    </div>
</footer>
...
<!-- jQuery -->
<script src="{{ asset('hydrogen-assets/js/jquery.min.js') }}"></script>
<!-- jQuery Easing -->
<script src="{{ asset('hydrogen-assets/js/jquery.easing.1.3.js') }}"></script>
<!-- Bootstrap -->
<script src="{{ asset('hydrogen-assets/js/bootstrap.min.js') }}"></script>
<!-- Waypoints -->
<script src="{{ asset('hydrogen-assets/js/jquery.waypoints.min.js') }}"></script>
<!-- Magnific Popup -->
<script src="{{ asset('hydrogen-assets/js/jquery.magnific-popup.min.js') }}"></script>
<!-- Salvattore -->
<script src="{{ asset('hydrogen-assets/js/salvattore.min.js') }}"></script>
<!-- Main JS -->
<script src="{{ asset('hydrogen-assets/js/main.js') }}"></script>

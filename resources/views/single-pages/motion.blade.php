...
<video autoplay muted loop id="bg-video">
    <source src="{{ asset('astro-assets/video/gfp-astro-timelapse.mp4') }}" type="video/mp4">
</video>
                ...
                <div class="mx-auto position-relative gallery-container">
                    ...
                    <div class="mx-auto tm-border-top gallery-slider">
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-01.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                        ...
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-02.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-03.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-04.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-05.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-06.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-07.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-08.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="{{ asset('astro-assets/img/gallery-img-09.jpg') }}" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
...
<script src="{{ asset('astro-assets/js/jquery-3.5.1.min.js') }}"></script>
<script src="{{ asset('astro-assets/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('astro-assets/js/slick.js') }}"></script>
<script src="{{ asset('astro-assets/js/templatemo-script.js') }}"></script>
</body>
</html>

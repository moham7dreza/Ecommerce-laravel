            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.html" class="logo">
                        <img src="{{ asset('app-assets/assets/images/logo.png') }}" alt="Chain App Dev">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                            <img src="{{ asset('app-assets/assets/images/slider-dec.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="right-image">
                    <img src="{{ asset('app-assets/assets/images/about-right-dec.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="pricing-item-regular">
                    ...
                    <div class="icon">
                        <img src="{{ asset('app-assets/assets/images/pricing-table-01.png') }}" alt="">
                    </div>
                    <ul>
...
<script src="{{ asset('app-assets/assets/js/owl-carousel.js') }}"></script>
<script src="{{ asset('app-assets/assets/js/animation.js') }}"></script>
<script src="{{ asset('app-assets/assets/js/imagesloaded.js') }}"></script>
<script src="{{ asset('app-assets/assets/js/popup.js') }}"></script>

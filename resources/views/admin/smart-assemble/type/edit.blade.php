    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.smart-assemble.type.update', $systemType->id) }}" method="post"
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $systemType->name) }}"
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brief" value="{{ old('brief', $systemType->brief) }}"
                                           class="form-control form-control-sm">
                                </div>
                                @error('brief')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_price_from"
                                           value="{{ old('start_price_from', $systemType->start_price_from) }}"
                                           class="form-control form-control-sm">
                                </div>
                                    ...
                                    <section class="col-md-{{ 6 / $number }}">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="currentImage"
                                                   value="{{ $key }}" id="{{ $number }}"
                                                   @if($systemType->image['currentImage'] == $key) checked @endif>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="" class="form-control form-control-sm" id="status">
                                        <option value="0" @if (old('status', $systemType->status) == 0) selected @endif>
                                            غیرفعال
                                        </option>
                                        <option value="1" @if (old('status', $systemType->status) == 1) selected @endif>
                                            فعال
                                        </option>
                                    </select>
                                </div>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="show_in_menu" id="" class="form-control form-control-sm"
                                            id="show_in_menu">
                                        <option value="0"
                                                @if (old('show_in_menu', $systemType->show_in_menu) == 0) selected @endif>
                                            غیرفعال
                                        </option>
                                        <option value="1"
                                                @if (old('show_in_menu', $systemType->show_in_menu) == 1) selected @endif>
                                            فعال
                                        </option>
                                    </select>
                                </div>

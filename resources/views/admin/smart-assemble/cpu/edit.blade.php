...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ویرایش نسل سیستم</li>
        </ol>
    </nav>
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.smart-assemble.cpu.update', $systemCpu->id) }}" method="post"
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $systemCpu->name) }}"
                                    ...
                                    <select name="system_type_id" id="" class="form-control form-control-sm">
                                        @foreach ($types as $type)
                                            <option value="{{ $type->id }}"
                                                    @if(old('system_type_id', $systemCpu->system_type_id) == $type->id) selected @endif>{{ $type->name }}</option>
                                        @endforeach
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_price_from"
                                           value="{{ old('start_price_from', $systemCpu->start_price_from) }}"
                                           class="form-control form-control-sm">
                                </div>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brief" value="{{ old('brief', $systemCpu->brief) }}"
                                           class="form-control form-control-sm">
                                </div>
                                @error('brief')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    ...
                                    <section class="col-md-{{ 6 / $number }}">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="currentImage"
                                                   value="{{ $key }}" id="{{ $number }}"
                                                   @if($systemCpu->image['currentImage'] == $key) checked @endif>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="" class="form-control form-control-sm" id="status">
                                        <option value="0" @if (old('status', $systemCpu->status) == 0) selected @endif>
                                            غیرفعال
                                        </option>
                                        <option value="1" @if (old('status', $systemCpu->status) == 1) selected @endif>
                                            فعال
                                        </option>
                                    </select>
                                </div>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="show_in_menu" id="" class="form-control form-control-sm"
                                            id="show_in_menu">
                                        <option value="0"
                                                @if (old('show_in_menu', $systemCpu->show_in_menu) == 0) selected @endif>
                                            غیرفعال
                                        </option>
                                        <option value="1"
                                                @if (old('show_in_menu', $systemCpu->show_in_menu) == 1) selected @endif>
                                            فعال
                                        </option>
                                    </select>
                                </div>

    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.smart-assemble.system.store') }}" method="post"
                        ...
                        <section class="row">
                                    ...
                                    <select name="system_config_id" id="" class="form-control form-control-sm">
                                        @foreach ($configs as $config)
                                            <option value="{{ $config->id }}"
                                                    @if(old('system_config_id') == $config->id) selected @endif>{{ $config->name. ' - '.$config->ram_gen }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="system_gen_id" id="" class="form-control form-control-sm">
                                        @foreach ($gens as $gen)
                                            <option value="{{ $gen->id }}"
                                                    @if(old('system_gen_id') == $gen->id) selected @endif>{{ $gen->name }}</option>
                                        @endforeach
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="system_user_type" value="{{ old('system_user_type') }}"
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="system_marketable" class="form-control form-control-sm"
                                            id="marketable">
                                        <option value="0" @if(old('system_marketable') == 0) selected @endif>غیرفعال
                                        </option>
                                        <option value="1" @if(old('system_marketable') == 1) selected @endif>فعال
                                        </option>
                                    </select>
                                </div>

    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="{{ route('admin.smart-assemble.system.components.store', $system->id) }}"
                                    ...
                                    <select name="case" class="form-control form-control-sm">
                                        @foreach ($case_category_products as $case)
                                            <option value="{{ $case->id }}"
                                                    @if(old('case') == $case->id) selected @endif>{{ $case->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('case')
                                    ...
                                    <select name="cpu" id="" class="form-control form-control-sm">
                                        @foreach ($cpu_category_products as $product)
                                            <option value="{{ $product->id }}"
                                                    @if(old('cpu') == $product->id) selected @endif>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('cpu')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="motherboard" id="" class="form-control form-control-sm">
                                        @foreach ($mb_category_products as $product)
                                            <option value="{{ $product->id }}"
                                                    @if(old('motherboard') == $product->id) selected @endif>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('motherboard')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ram" id="" class="form-control form-control-sm">
                                        @foreach ($ram_category_products as $product)
                                            <option value="{{ $product->id }}"
                                                    @if(old('ram') == $product->id) selected @endif>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('ram')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="psu" id="" class="form-control form-control-sm">
                                        @foreach ($psu_category_products as $product)
                                            <option value="{{ $product->id }}"
                                                    @if(old('psu') == $product->id) selected @endif>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('psu')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="case" id="" class="form-control form-control-sm">
                                        @foreach ($hdd_category_products as $product)
                                            <option value="{{ $product->id }}"
                                                    @if(old('hdd') == $product->id) selected @endif>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('hdd')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ssd" id="" class="form-control form-control-sm">
                                        @foreach ($ssd_category_products as $product)
                                            <option value="{{ $product->id }}"
                                                    @if(old('ssd') == $product->id) selected @endif>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('ssd')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gpu" id="" class="form-control form-control-sm">
                                        @foreach ($gpu_category_products as $product)
                                            <option value="{{ $product->id }}"
                                                    @if(old('gpu') == $product->id) selected @endif>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('gpu')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cooler" id="" class="form-control form-control-sm">
                                        @foreach ($cooler_category_products as $product)
                                            <option value="{{ $product->id }}"
                                                    @if(old('cooler') == $product->id) selected @endif>{{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('cooler')

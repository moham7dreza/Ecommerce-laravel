                            ...
                            <td class="width-8-rem text-left">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <a href="{{ route('admin.user.admin-user.role-form', $admin->id) }}" class="dropdown-item text-right"><i class="fa fa-edit"></i>نقش ها</a>
                                        <a href="{{ route('admin.user.admin-user.edit', $admin->id) }}" class="dropdown-item text-right"><i class="fa fa-edit"></i> ویرایش</a>

            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
                    <div class="product_list">
                        <div class="product_img"> <img class="img-responsive" src="{{ asset('it-next-assets/system.png') }}" alt=""> </div>
                        <div class="product_detail_btm">
                            ...
                            <div class="product_price">
                                <p><span class="old_price">۳۰۰۰۰۰۰ تومان</span> – <span class="new_price">۴۰۰۰۰۰۰ تومان</span></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 text-right">
                    <div class="full blog_colum">
                        <div class="blog_feature_img"> <img src="{{ asset('it-next-assets/images/it_service/post-03.jpg') }}" alt="#" /> </div>
                        <div class="post_time">
                ...
                <div class="col-md-12">
                    <div class="full">
                        <div class="contact_us_section rtl">
                            <div class="call_icon"> <img src="{{ asset('it-next-assets/images/it_service/phone_icon.png') }}" alt="#" /> </div>
                            <div class="inner_cont">
                                <h2>درخواست یک نقل قول رایگان</h2>
                                <p>از افرادی که می خواهید پاسخ و مشاوره دریافت کنید.</p>
                            </div>
                            <div class="button_Section_cont"> <a class="btn dark_gray_bt" href="it_contact.html">ارتباط با ما</a> </div>
                        </div>
                    </div>
                </div>
            </div>

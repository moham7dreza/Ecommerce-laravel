...
class SystemGen extends Model
{
    ...
    protected $fillable = ['name', 'brief','description', 'slug', 'image', 'start_price_from', 'status', 'type', 'tags', 'show_in_menu', 'system_category_id', 'system_type_id'];

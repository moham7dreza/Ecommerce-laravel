...
use App\Http\Repositories\Panel\PermissionRepo;
use App\Http\Repositories\Panel\RoleRepo;
use App\Http\Requests\Panel\RoleRequest;
use App\Http\Services\Panel\RoleService;
...
class RoleController extends Controller
{
    ...
    public function store(RoleRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('panel.role.index')->with('swal-success', 'نقش با موفقیت ذخیره شد.');
    }
    ...
    public function update(RoleRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('panel.role.index')->with('swal-success', 'نقش با موفقیت ویرایش شد.');
    }
    ...
    {
        $this->repo->delete($id);
        return redirect()->route('panel.role.index')->with('swal-success', 'نقش با موفقیت حذف شد.');
    }
...
//        $this->authorize('index', Category::class);
        ...
        return redirect()->route('panel.role.index')->with('swal-success', 'وضعیت نقش با موفقیت تغییر کرد.');
    }
}

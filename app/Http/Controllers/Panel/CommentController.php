...
use App\Http\Repositories\Panel\CommentRepo;
...
class CommentController extends Controller
{
    ...
    {
        $this->repo->delete($id);
        return redirect()->route('panel.comment.index')->with('swal-success', 'نظر با موفقیت حذف شد.');
    }
...
//        $this->authorize('manage', $this->class);
        ...
        return redirect()->route('panel.comment.index')->with('swal-success', 'وضعیت نظر با موفقیت تغییر کرد.');

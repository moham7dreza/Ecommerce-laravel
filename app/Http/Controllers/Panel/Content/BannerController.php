...
use App\Http\Repositories\Panel\Content\BannerRepo;
use App\Http\Requests\Panel\Content\BannerRequest;
use App\Http\Services\Image\ImageService;
use App\Http\Services\Panel\Content\BannerService;
...
class BannerController extends Controller
{
    ...
    public function store(BannerRequest $request, ImageService $imageService): RedirectResponse
    {
        ...
        return redirect()->route('panel.content.banner.index')->with('swal-success', 'بنر تبلیغاتی با موفقیت ذخیره شد.');
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('panel.content.banner.edit', compact(['banner']));
    }
    ...
    public function update(BannerRequest $request, ImageService $imageService, int $id): RedirectResponse
    {
        ...
        return redirect()->route('panel.content.banner.index')->with('swal-success', 'بنر تبلیغاتی با موفقیت ویرایش شد.');
    }
    ...
    {
        $this->repo->delete($id);
        return redirect()->route('panel.content.banner.index')->with('swal-success', 'بنر تبلیغاتی با موفقیت حذف شد.');
    }

...
use App\Http\Repositories\Panel\MenuRepo;
use App\Http\Requests\Panel\MenuRequest;
use App\Http\Services\Panel\MenuService;
...
class MenuController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('panel.menu.create', compact(['menus']));
    }
    ...
    public function store(MenuRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('panel.menu.index')->with('swal-success', 'منو با موفقیت ذخیره شد.');
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('panel.menu.edit', compact(['menus', 'menu']));
    }
    ...
    public function update(MenuRequest $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('panel.menu.index')->with('swal-success', 'منو با موفقیت ویرایش شد.');
    }
    ...
    {
        $this->repo->delete($id);
        return redirect()->route('panel.menu.index')->with('swal-success', 'منو با موفقیت حذف شد.');
    }
...
//        $this->authorize('index', Category::class);
        ...
        return redirect()->route('panel.m`enu.index')->with('swal-success', 'وضعیت منو با موفقیت تغییر کرد.');
    }
}

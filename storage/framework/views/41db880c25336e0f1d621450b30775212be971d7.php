                ...
                <div class="card shade h-100">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="p-2">
                                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('panel.office.category.store')); ?>"
...
unset($__errorArgs, $__bag); ?>" name="status">
                                                    <?php $__currentLoopData = \App\Models\ItCity\Office\ServiceCategory::$statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($status->value); ?>" <?php if(old('status') == $status->value): ?> selected <?php endif; ?>>
                                                            <?php if($status->value == 1): ?> فعال <?php else: ?> غیر فعال <?php endif; ?></option>
...
<?php echo $__env->make('panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/panel/office/category/create.blade.php ENDPATH**/ ?>
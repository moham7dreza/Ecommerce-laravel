            ...
            <div class="sidebar-widget mb-30">
                <div class="widget-top-auhor border-radius-10 p-20 bg-white">
                    ...
                    <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="red-tooltip active" href="<?php echo e($author->path()); ?>" data-toggle="tooltip" data-placement="top"
                           data-original-title="<?php echo e($author->fullName); ?> - <?php echo e($author->posts->count()); ?> مقاله">

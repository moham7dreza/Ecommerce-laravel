...
<div class="row m-1 mb-2">
    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
        <div class="box-card text-right mini animate__animated animate__flipInY"><i
            ...
            <span><?php echo e($panelRepo->postsCount()); ?></span>
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
        <div class="box-card text-right mini animate__animated animate__flipInY"><i
            ...
            <span><?php echo e($panelRepo->usersCount()); ?></span>
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
        <div class="box-card text-right mini animate__animated animate__flipInY"><i
            ...
            <span><?php echo e($panelRepo->commentsCount()); ?></span>
    ...
    <div class="col-xl-3 col-md-6 col-sm-6 p-2">
        <div class="box-card text-right mini animate__animated animate__flipInY"><i
            ...
            <span><?php echo e($panelRepo->hardwareCount()); ?></span>
            <p class="mt-3 mb-1 text-right"><i class="fab fa-bluetooth mr-1 c-forth"></i>در حال پیشرفت
            </p>
        </div>
    </div>
</div>
<?php /**PATH C:\CODEX\techzilla\resources\views/panel/partials/counter.blade.php ENDPATH**/ ?>
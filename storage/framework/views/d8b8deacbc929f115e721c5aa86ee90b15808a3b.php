                        ...
                        <?php $__currentLoopData = $unseenComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unseenComment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <i class="fa fa-times"><p
                                        class="notification-time ml-2"><?php echo e($unseenComment->textAuthorName()); ?></p></i>
            ...
            <li class="nav-item">
                <div class="dropdown">
                    ...
                    <div aria-labelledby="dropdownMenu2"
                         class="dropdown-menu dropdown-menu-right dropdown-menu dropdown-menu-right-lg">
                        <span
                            class="dropdown-item dropdown-header persianumber"><?php echo e($notifications->count()); ?> اطلاعیه</span>

                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="dropdown-divider"></div>
                            <a href="#" class="dropdown-item">
                                <i class="fa fa-times"><p
                                        class="notification-time ml-2"><?php echo e($notification['data']['message']); ?></p></i>

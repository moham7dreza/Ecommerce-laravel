...
<head>
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" href="<?php echo e(asset('hydrogen-assets/css/animate.css')); ?>">
    <!-- Icomoon Icon Fonts-->
    <link rel="stylesheet" href="<?php echo e(asset('hydrogen-assets/css/icomoon.css')); ?>">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="<?php echo e(asset('hydrogen-assets/css/magnific-popup.css')); ?>">
    <!-- Salvattore -->
    <link rel="stylesheet" href="<?php echo e(asset('hydrogen-assets/css/salvattore.css')); ?>">
    <!-- Theme Style -->
    <link rel="stylesheet" href="<?php echo e(asset('hydrogen-assets/css/style.css')); ?>">
    <!-- Modernizr JS -->
    <script src="<?php echo e(asset('hydrogen-assets/js/modernizr-2.6.2.min.js')); ?>"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
    <script src="<?php echo e(asset('hydrogen-assets/js/respond.min.js')); ?>"></script>
    <![endif]-->
...
<!-- jQuery -->
<script src="<?php echo e(asset('hydrogen-assets/js/jquery.min.js')); ?>"></script>
<!-- jQuery Easing -->
<script src="<?php echo e(asset('hydrogen-assets/js/jquery.easing.1.3.js')); ?>"></script>
<!-- Bootstrap -->
<script src="<?php echo e(asset('hydrogen-assets/js/bootstrap.min.js')); ?>"></script>
<!-- Waypoints -->
<script src="<?php echo e(asset('hydrogen-assets/js/jquery.waypoints.min.js')); ?>"></script>
<!-- Magnific Popup -->
<script src="<?php echo e(asset('hydrogen-assets/js/jquery.magnific-popup.min.js')); ?>"></script>
<!-- Salvattore -->
<script src="<?php echo e(asset('hydrogen-assets/js/salvattore.min.js')); ?>"></script>
<!-- Main JS -->
<script src="<?php echo e(asset('hydrogen-assets/js/main.js')); ?>"></script>
...
<?php /**PATH C:\CODEX\techzilla\resources\views/single-pages/hydrogen.blade.php ENDPATH**/ ?>
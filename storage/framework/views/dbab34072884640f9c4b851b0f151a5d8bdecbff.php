                    ...
                    <table class="table table-striped table-hover h-150px" id="printable">
                        ...
                        <tr class="table-primary">
                            ...
                            <td class="width-8-rem text-left">
                                ...
                                <a href="<?php echo e(route('admin.market.order.show.detail', $order->id)); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/order/show.blade.php ENDPATH**/ ?>
                    ...
                    <div class="full">
                        <div class="title-holder">
                            <div class="title-holder-cell text-right">
                                <h1 class="page-title">برنامه های قیمت گذاری ما</h1>
                                <ol class="breadcrumb rtl">
                                    ...
                                    <li class="active">برنامه های قیمت گذاری ما</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('it-city.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/it-city/pages/price.blade.php ENDPATH**/ ?>
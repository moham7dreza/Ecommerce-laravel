                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr class="border-bottom">
                            <th>محبوبیت سیستم</th>
                            <td class="text-left font-weight-bolder">
                                <?php echo e($system->system_rating ?? '-'); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\project-toplearn\resources\views/admin/smart-assemble/system/components/index.blade.php ENDPATH**/ ?>
                    ...
                    <section class="row mt-4">
                        <section class="col-md-9">
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <form action="<?php echo e(route('customer.sales-process.payment-submit')); ?>" method="post" id="payment_submit">
                                    <?php echo csrf_field(); ?>
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-danger fw-bolder"><span
                                            id="total_discount"><?php echo e(priceFormat($order->commonDiscount->percentage)); ?></span> درصد</p>
                                </section>

                                <section class="d-flex justify-content-between align-items-center">
                                    <p class="text-muted">میزان حداکثر تخفیف عمومی</p>
                                    <p class="text-danger fw-bolder"><span
                                            id="total_discount"><?php echo e(priceFormat($order->commonDiscount->discount_ceiling)); ?></span> تومان</p>
                                </section>
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-danger fw-bolder"><span
                                            id="total_discount"><?php echo e(priceFormat($order->commonDiscount->minimal_order_amount)); ?></span> تومان</p>
                                </section>
...
<?php echo $__env->make('customer.layouts.master-two-col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/customer/sales-process/payment.blade.php ENDPATH**/ ?>
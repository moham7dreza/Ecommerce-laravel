<div class="container-fluid side-bar-container ">
    ...
    <li class="side a-collapse short m-2 pr-1 pl-1">
        <a href="<?php echo e(route('digital-world.home')); ?>" class="side-item selected c-dark "><i
    ...
    <li class="side a-collapse short">
        <a href="<?php echo e(route('panel.reports.charts.sales')); ?>" class="side-item "><i class="fas fa-fan fa-spin mr-1"></i>نمودار
            فروش</a>
    </li>

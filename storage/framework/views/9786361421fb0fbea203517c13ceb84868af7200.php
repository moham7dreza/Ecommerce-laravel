<div class="container-fluid side-bar-container ">
    <header class="pb-0">
        <a class="navbar-brand ">
            <object class="side-logo" data="<?php echo e(asset('panel-assets/svg/logo-8.svg')); ?>" type="image/svg+xml">
            </object>
        </a>
    </header>
    ...
    <li class="side a-collapse short ">
        <a href="<?php echo e(route('panel.bot.message')); ?>" class="side-item "><i class="fas fa-fan fa-spin mr-1"></i>ارسال پیام</a>
    </li>

    <p class="side-comment  fnt-mxs">گزارشات</p>
    <li class="side a-collapse short ">
        <a href="<?php echo e(route('panel.reports.charts.sales')); ?>" class="side-item "><i class="fas fa-fan fa-spin mr-1"></i>نمودار فروش</a>
    </li>

                            ...
                            <tbody>
                                <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="row">
                                                <form action="<?php echo e(route('panel.office.comment.change.status', $comment->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                ...
                                                <form action="<?php echo e(route('panel.office.comment.change.approve', $comment->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                                ...
                                                <form action="<?php echo e(route('panel.office.comment.destroy', $comment->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>

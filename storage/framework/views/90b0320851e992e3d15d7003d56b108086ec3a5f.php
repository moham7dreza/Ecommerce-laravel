            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('adminto.category.store')); ?>" id="form">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('name')); ?>" id="name" name="name" placeholder="عنوان دسته بندی را وارد کنید">
...
unset($__errorArgs, $__bag); ?>" name="status">
                                                <?php $__currentLoopData = \App\Models\Content\PostCategory::$statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($status); ?>" <?php if(old('status') == $status): ?> selected <?php endif; ?>><?php echo app('translator')->get($status); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="parent_id">
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($category->id); ?>"
                                                            <?php if(old('parent_id') == $category->id): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            placeholder="توضیحات دسته بندی را وارد کنید"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('adminto.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/adminto/category/create.blade.php ENDPATH**/ ?>
                ...
                <div class="card shade h-100">
                    <div class="card-body">
                        <div class="float-left cart-title">
                            <a href="<?php echo e(route('panel.banner.create')); ?>" class="arrow-none btn btn-primary text-white"
                               aria-expanded="false">
                                ساخت تبلیغات جدید
                            </a>
                        </div>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="row">
                                                <a href="<?php echo e(route('panel.banner.edit', $banner->id)); ?>"
                                                   class="btn btn-warning">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form action="<?php echo e(route('panel.banner.change.status', $banner->id)); ?>"
                                                      method="POST">
                                                    <?php echo csrf_field(); ?>
                                                ...
                                                <form action="<?php echo e(route('panel.banner.destroy', $banner->id)); ?>"
                                                      method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/panel/banner/index.blade.php ENDPATH**/ ?>
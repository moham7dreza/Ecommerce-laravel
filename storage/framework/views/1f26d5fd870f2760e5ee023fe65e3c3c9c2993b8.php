        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="<?php echo e(route('admin.market.delivery.create')); ?>" class="btn btn-info btn-sm">ایجاد روش ارسال
                        جدید </a>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php $__currentLoopData = $delivery_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery_method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input id="<?php echo e($delivery_method->id); ?>"
                                               onchange="changeStatus(<?php echo e($delivery_method->id); ?>)"
                                               data-url="<?php echo e(route('admin.market.delivery.status', $delivery_method->id)); ?>"
                                               type="checkbox" <?php if($delivery_method->status === 1): ?>
                                                   checked
                                            <?php endif; ?>>
                                    </label>
                                </td>
                                <td class="width-16-rem text-left">
                                    <a href="<?php echo e(route('admin.market.delivery.edit', $delivery_method->id)); ?>"
                                       class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
                                    <form class="d-inline"
                                          action="<?php echo e(route('admin.market.delivery.destroy', $delivery_method->id)); ?>"
                                          method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/delivery/index.blade.php ENDPATH**/ ?>
...
<section id="main-body-two-col" class="container-xxl body-container">
    <section class="row">
        ...
        <?php echo $__env->make('customer.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\CODEX\techzilla\resources\views/customer/layouts/master-two-col.blade.php ENDPATH**/ ?>
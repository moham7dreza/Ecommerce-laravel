        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="<?php echo e(route('admin.user.admin-user.create')); ?>" class="btn btn-info btn-sm">ایجاد ادمین
                        جدید</a>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input id="<?php echo e($admin->id); ?>-active" onchange="changeActive(<?php echo e($admin->id); ?>)"
                                               data-url="<?php echo e(route('admin.user.admin-user.activation', $admin->id)); ?>"
                                               type="checkbox" <?php if($admin->activation === 1): ?>
                                                   checked
                                            <?php endif; ?>>
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        <input id="<?php echo e($admin->id); ?>" onchange="changeStatus(<?php echo e($admin->id); ?>)"
                                               data-url="<?php echo e(route('admin.user.admin-user.status', $admin->id)); ?>"
                                               type="checkbox" <?php if($admin->status === 1): ?>
                                                   checked
                                            <?php endif; ?>>
                                    </label>
                                </td>
                                ...
                                <td class="width-8-rem text-left">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a href="<?php echo e(route('admin.user.admin-user.role-form', $admin->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-edit"></i>نقش ها</a>
                                            <a href="<?php echo e(route('admin.user.admin-user.edit', $admin->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-edit"></i> ویرایش</a>
                                            <form class="d-inline"
                                                  action="<?php echo e(route('admin.user.admin-user.destroy', $admin->id)); ?>"
                                                  method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/user/admin-user/index.blade.php ENDPATH**/ ?>
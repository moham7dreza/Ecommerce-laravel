                ...
                <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                    ...
                    <section class="mt-3 mt-md-auto text-end">
                        ...
                        <section class="d-inline px-md-3">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('admin.home')); ?>" class="btn btn-link text-decoration-none text-dark profile-button">
            ...
            <section class="container-xxl ">
                <nav class="">
                    <section class="d-none d-md-flex justify-content-md-start position-relative">
                        ...
                        <section class="navbar-item"><a href="<?php echo e(route('smart.assemble.categories')); ?>">پی سی پیک</a></section>
                        <section class="navbar-item"><a href="<?php echo e(route('smart.assemble.index')); ?>">اسمبل</a></section>
...
<?php /**PATH C:\CODEX\project-toplearn\resources\views/customer/layouts/header.blade.php ENDPATH**/ ?>
                    ...
                    <section class="d-inline px-md-3">
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                                ...
                                <section><a class="dropdown-item" href="<?php echo e(route('user.profile')); ?>"><i
                                            class="fa fa-user-circle"></i>پروفایل کاربری</a></section>
                                <section><a class="dropdown-item" href="<?php echo e(route('user.orders')); ?>"><i
                                            class="fa fa-newspaper"></i>سفارشات</a></section>
                                <section><a class="dropdown-item" href="<?php echo e(route('user.favorites')); ?>"><i
                                ...
                                <section><a class="dropdown-item" href="<?php echo e(route('customer.home')); ?>"><i
...
<!-- end header -->
<?php /**PATH C:\wamp64\www\CODEX\techzilla\resources\views/customer/layouts/header.blade.php ENDPATH**/ ?>

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('letter-assets/css/demo.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('letter-assets/css/templatemo-style.css')); ?>">

    <script type="text/javascript" src="<?php echo e(asset('letter-assets/js/modernizr.custom.86080.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('letter-assets/js/particles.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('letter-assets/js/app.js')); ?>"></script>
</html>
<?php /**PATH C:\CODEX\techzilla\resources\views/single-pages/letter.blade.php ENDPATH**/ ?>
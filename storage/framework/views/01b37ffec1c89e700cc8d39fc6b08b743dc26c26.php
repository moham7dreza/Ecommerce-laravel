...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="m-t-0 header-title">ویرایش تنظیمات - <?php echo e($setting->title); ?></h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('adminto.setting.update', $setting->id)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('title', $setting->title)); ?>" id="title" title="title">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('keywords', $setting->keywords)); ?>" id="keywords" name="keywords">
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            ><?php echo e(old('description', $setting->description)); ?></textarea>
...
<?php echo $__env->make('adminto.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/adminto/setting/edit.blade.php ENDPATH**/ ?>
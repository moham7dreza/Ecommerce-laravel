<?php $__env->startSection('head-tag'); ?>
    <title>ویرایش بنر - <?php echo e($banner->title); ?></title>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="m-t-0 header-title">ویرایش بنر - <?php echo e($banner->title); ?></h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('adminto.banner.update', $banner->id)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e($banner->title); ?>" id="title" name="title" placeholder="عنوان تبلیغات را وارد کنید">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('url', $banner->url)); ?>" id="url" name="url">
                                            <?php $__errorArgs = ['url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="position"
                                                ...
                                                <?php $__currentLoopData = \App\Models\Content\Banner::$postBannersPositions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php if(old('position', $banner->position) === $key): ?> selected <?php endif; ?>
                                                        value="<?php echo e($key); ?>"><?php echo app('translator')->get($position); ?>
                                                    </option>
...
unset($__errorArgs, $__bag); ?>" name="status">
                                                <?php $__currentLoopData = \App\Models\Content\Banner::$statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($status); ?>" <?php if(old('status', $banner->status) == $status): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('adminto.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/adminto/banner/edit.blade.php ENDPATH**/ ?>
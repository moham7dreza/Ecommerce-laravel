<div class="post-carausel-1-items mb-50">
    <?php $__currentLoopData = $vipPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col">
            <div class="slider-single bg-white p-10 border-radius-15">
                ...
                <h6 class="post-title pr-5 pl-5 mb-10 mt-15 text-limit-2-row">
                    <a href="<?php echo e(route('digital-world.livewire.post.detail', $post)); ?>"><?php echo e($post->title); ?></a>
                </h6>
...
<?php /**PATH C:\CODEX\techzilla\resources\views/livewire/digital-world/partials/vip-posts.blade.php ENDPATH**/ ?>
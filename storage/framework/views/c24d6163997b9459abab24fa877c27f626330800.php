            ...
            <div class="col-lg-12">
                <div class="card shade h-100">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('panel.menu.create')); ?>" class="arrow-none btn btn-primary text-white" aria-expanded="false">
                            ساخت منوی جدید
                        </a>
                    </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="row">
                                                <a href="<?php echo e(route('panel.menu.edit', $menu->id)); ?>" class="btn btn-warning">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form action="<?php echo e(route('panel.menu.change.status', $menu->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                ...
                                                <form action="<?php echo e(route('panel.menu.destroy', $menu->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/panel/menu/index.blade.php ENDPATH**/ ?>
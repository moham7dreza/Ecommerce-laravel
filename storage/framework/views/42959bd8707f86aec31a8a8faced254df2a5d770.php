...
<?php $__env->startSection('content'); ?>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ویرایش سیستم</li>
        </ol>
    </nav>
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="<?php echo e(route('admin.smart-assemble.system.update', $system->id)); ?>" method="post"
                                    ...
                                    <select name="system_config_id" id="" class="form-control form-control-sm">
                                        <?php $__currentLoopData = $configs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($config->id); ?>"
                                                    <?php if(old('system_config_id', $system->system_config_id) == $config->id): ?> selected <?php endif; ?>><?php echo e($config->name); ?></option>
                                    ...
                                    <select name="system_gen_id" id="" class="form-control form-control-sm">
                                        <?php $__currentLoopData = $gens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($gen->id); ?>"
                                                    <?php if(old('system_gen_id', $system->system_gen_id) == $gen->id): ?> selected <?php endif; ?>><?php echo e($gen->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                    ...
                                    <select name="system_type_id" id="" class="form-control form-control-sm">
                                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type->id); ?>"
                                                    <?php if(old('system_type_id', $system->system_type_id) == $type->id): ?> selected <?php endif; ?>><?php echo e($type->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                    ...
                                    <select name="system_category_id" id="" class="form-control form-control-sm">
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>"
                                                    <?php if(old('system_category_id', $system->system_category_id) == $category->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="system_user_type"
                                           value="<?php echo e(old('system_user_type', $system->system_user_type)); ?>"
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control form-control-sm"
                                              rows="6">
                                    <?php echo e(old('description', $system->description)); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <section class="row">
                                <?php
                                    $number = 1;
                                ?>
                                <?php $__currentLoopData = $system->image['indexArray']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <section class="col-md-<?php echo e(6 / $number); ?>">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="currentImage"
                                                   ...
                                                   <?php if($system->image['currentImage'] == $key): ?> checked <?php endif; ?>>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="" class="form-control form-control-sm" id="status">
                                        <option value="0" <?php if(old('status', $system->status) == 0): ?> selected <?php endif; ?>>
                                            غیرفعال
                                        </option>
                                        <option value="1" <?php if(old('status', $system->status) == 1): ?> selected <?php endif; ?>>
                                            فعال
                                        </option>
                                    </select>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="system_marketable" class="form-control form-control-sm"
                                            id="marketable">
                                        <option value="0"
                                                <?php if(old('system_marketable', $system->system_marketable) == 0): ?> selected <?php endif; ?>>
                                            غیرفعال
                                        </option>
                                        <option value="1"
                                                <?php if(old('system_marketable', $system->system_marketable) == 1): ?> selected <?php endif; ?>>
                                            فعال
                                        </option>
                                    </select>
                                </div>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control form-control-sm" name="tags" id="tags"
                                           value="<?php echo e(old('tags', $system->tags)); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/admin/smart-assemble/system/edit.blade.php ENDPATH**/ ?>
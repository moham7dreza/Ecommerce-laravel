                            ...
                            <div class="form-group">
                                ...
                                <select name="system_config_id" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $configs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($config->id); ?>"  <?php if(old('system_config_id') == $config->id): ?> selected <?php endif; ?>><?php echo e($config->name); ?></option>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\project-toplearn\resources\views/admin/smart-assemble/system/create.blade.php ENDPATH**/ ?>
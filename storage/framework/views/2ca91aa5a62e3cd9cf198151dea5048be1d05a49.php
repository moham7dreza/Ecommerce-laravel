    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="<?php echo e(route('admin.content.post.store')); ?>" method="POST" enctype="multipart/form-data"
                          id="form">
                        <?php echo csrf_field(); ?>
                        <section class="row">
                                    ...
                                    <select name="category_id" id="" class="form-control form-control-sm">
                                        ...
                                        <?php $__currentLoopData = $postCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($postCategory->id); ?>"
                                                    <?php if(old('category_id') == $postCategory->id): ?> selected <?php endif; ?>><?php echo e($postCategory->name); ?></option>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="time_to_read"
                                           value="<?php echo e(old('time_to_read')); ?>">
                                </div>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" id="summary" class="form-control form-control-sm"
                                              rows="6"><?php echo e(old('summary')); ?></textarea>
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/content/post/create.blade.php ENDPATH**/ ?>
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="<?php echo e(route('admin.content.post.update', $post->id)); ?>" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="" class="form-control form-control-sm">
                                        ...
                                        <?php $__currentLoopData = $postCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($postCategory->id); ?>"
                                                    <?php if(old('category_id', $post->category_id) == $postCategory->id): ?> selected <?php endif; ?>><?php echo e($postCategory->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="time_to_read"
                                           value="<?php echo e(old('time_to_read', $post->time_to_read)); ?>">
                                </div>
                                    ...
                                    <section class="col-md-<?php echo e(6 / $number); ?>">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="currentImage"
                                                   ...
                                                   <?php if($post->image['currentImage'] == $key): ?> checked <?php endif; ?>>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="" class="form-control form-control-sm" id="status">
                                        <option value="0" <?php if(old('status', $post->status) == 0): ?> selected <?php endif; ?>>
                                            غیرفعال
                                        </option>
                                        <option value="1" <?php if(old('status', $post->status) == 1): ?> selected <?php endif; ?>>فعال
                                        </option>
                                    </select>
                                </div>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="commentable" id="" class="form-control form-control-sm"
                                            id="commentable">
                                        <option value="0"
                                                <?php if(old('commentable', $post->commentable) == 0): ?> selected <?php endif; ?>>
                                            غیرفعال
                                        </option>
                                        <option value="1"
                                                <?php if(old('commentable', $post->commentable) == 1): ?> selected <?php endif; ?>>فعال
                                        </option>
                                    </select>
                                </div>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" id="summary" class="form-control form-control-sm"
                                              rows="6"><?php echo old('summary', $post->summary); ?></textarea>
                                </div>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="body" id="body" class="form-control form-control-sm"
                                              rows="6"><?php echo old('body', $post->body); ?></textarea>
                                </div>

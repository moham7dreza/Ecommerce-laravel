<div class="col-lg-2 col-md-3 primary-sidebar sticky-sidebar sidebar-left order-2 order-md-1">
    ...
    <div class="sidebar-widget widget_categories border-radius-10 bg-white mb-30">
        ...
        <ul class="font-small text-muted">
            <?php $__currentLoopData = $homeRepo->getActiveCategories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\CODEX\techzilla\resources\views/digital-world/layouts/partials/right-sidebar.blade.php ENDPATH**/ ?>
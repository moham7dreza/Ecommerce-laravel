...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('b2XUQD3')) {
    $componentId = $_instance->getRenderedChildComponentId('b2XUQD3');
    $componentTag = $_instance->getRenderedChildComponentTagName('b2XUQD3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('b2XUQD3');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('b2XUQD3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
} elseif ($_instance->childHasBeenRendered('QSh7tsZ')) {
    $componentId = $_instance->getRenderedChildComponentId('QSh7tsZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('QSh7tsZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QSh7tsZ');
} else {
    $response = \Livewire\Livewire::mount('log-viewer::log-list');
    $html = $response->html();
    $_instance->logRenderedChild('QSh7tsZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>

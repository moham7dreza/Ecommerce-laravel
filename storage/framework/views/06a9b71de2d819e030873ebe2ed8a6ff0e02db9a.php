...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page">ایجاد نسل جدید</li>
    </ol>
  </nav>
    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="<?php echo e(route('admin.smart-assemble.cpu.index')); ?>" class="btn btn-info btn-sm">بازگشت</a>
            </section>

            <section>
                <form action="<?php echo e(route('admin.smart-assemble.cpu.store')); ?>" method="post" enctype="multipart/form-data" id="form">
                    <?php echo csrf_field(); ?>
                    <section class="row">

                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="name">نسل سیستم</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="system_type_id">انتخاب نوع سیستم</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="system_category_id">انتخاب دسته سیستم</label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\1 - laravel-shop-project\resources\views/admin/smart-assemble/cpu/create.blade.php ENDPATH**/ ?>
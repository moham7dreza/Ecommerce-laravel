                        ...
                        <div class="title-holder">
                            <div class="title-holder-cell text-right">
                                ...
                                <ol class="breadcrumb rtl">
                                    ...
                                    <li><a href="<?php echo e(route('smart.assemble.pc-part-picker')); ?>">اسمبل هوشمند</a></li>
            ...
            <div class="row rtl text_align_right" style="margin-top: 35px">
                ...
                <div class="col-md-4">
                    <div class="full" style="margin-top: 35px;">
                        ...
                        <p><a class="btn main_bt" href="<?php echo e(route('smart.assemble.pc-part-picker')); ?>">اسمبل هوشمند</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('smart-assemble.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/smart-assemble/pages/about-us.blade.php ENDPATH**/ ?>
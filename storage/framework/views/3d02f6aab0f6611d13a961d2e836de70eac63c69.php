                    ...
                    <section class="row mt-4">
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <section class="address-select">
                                    ...
                                    <?php $__currentLoopData = auth()->user()->addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <input type="radio" form="myForm" name="address_id" value="<?php echo e($address->id); ?>"
                                ...
                                <section class="delivery-select ">
                                    ...
                                    <?php $__currentLoopData = $deliveryMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deliveryMethod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <input type="radio" form="myForm" name="delivery_id"
                                               value="<?php echo e($deliveryMethod->id); ?>" id="d-<?php echo e($deliveryMethod->id); ?>"/>
                                        <label for="d-<?php echo e($deliveryMethod->id); ?>"
                                            ...
                                            <section class="mb-2">
                                                ...
                                                تامین کالا
                                                از <?php echo e($deliveryMethod->delivery_time); ?> <?php echo e($deliveryMethod->delivery_time_unit); ?>
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <form action="<?php echo e(route('customer.sales-process.choose-address-and-delivery')); ?>"
...
<?php echo $__env->make('customer.layouts.master-two-col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/customer/sales-process/address-and-delivery.blade.php ENDPATH**/ ?>
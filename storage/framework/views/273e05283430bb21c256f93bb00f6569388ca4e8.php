                                ...
                                <td>
                                    <label>
                                        <input id="<?php echo e($comment->id); ?>" onchange="changeStatus(<?php echo e($comment->id); ?>)"
                                               data-url="<?php echo e(route('admin.content.comment.status', $comment->id)); ?>"
                                ...
                                <td class="width-8-rem text-left">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a href="<?php echo e(route('admin.content.comment.show', $comment->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-eye"></i> نمایش</a>

                                            <?php if($comment->approved == 1): ?>
                                                <a href="<?php echo e(route('admin.content.comment.approved', $comment->id)); ?>"

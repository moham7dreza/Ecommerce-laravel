                ...
                <?php $__currentLoopData = $systemTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $systemType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col">
                        ...
                        <div class="card shadow-sm">
                            <a href="<?php echo e(route('smart.assemble.cpus', ['systemCategory' => $systemCategory, 'systemType' => $systemType])); ?>">
...
<?php echo $__env->make('customer.layouts.master-one-col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\1 - laravel-shop-project\resources\views/smart-assemble/type.blade.php ENDPATH**/ ?>
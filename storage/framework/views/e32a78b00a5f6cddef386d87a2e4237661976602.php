        ...
        <section class="container-xxl ">
            <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                ...
                <section class="d-flex justify-content-between align-items-center d-md-block">
                    <a class="text-decoration-none" href="<?php echo e(route('customer.home')); ?>"><img
                            src="<?php echo e(asset('customer-assets/images/logo/8.png')); ?>" alt="logo"></a>
        ...
        <section class="container-xxl ">
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-start position-relative">
                    ...
                    <section class="navbar-item"><a href="<?php echo e(route('smart.assemble.categories')); ?>">پی سی پیک</a>
                    </section>

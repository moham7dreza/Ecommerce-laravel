            ...
            <div class="last-comment mb-20 d-flex wow fadeIn animated">
                                            <span class="item-count vertical-align">
                                                <a class="red-tooltip author-avatar"
                                                   href="<?php echo e($comment->getAuthorPath()); ?>"
                                                   data-toggle="tooltip" data-placement="top"
                                                   data-original-title="<?php echo e($comment->textAuthorName()); ?> - <?php echo e($comment->getAuthorPostsCount()); ?> پست">
                                                    <img src="<?php echo e($comment->authorImage()); ?>"
                                                         alt="<?php echo e($comment->textAuthorName()); ?>">
                                                </a>
                                            </span>
...
<?php /**PATH C:\CODEX\techzilla\resources\views/digital-world/layouts/partials/comments.blade.php ENDPATH**/ ?>
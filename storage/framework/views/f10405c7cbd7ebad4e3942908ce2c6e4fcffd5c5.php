                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input id="<?php echo e($comment->id); ?>" onchange="changeStatus(<?php echo e($comment->id); ?>)"
                                               data-url="<?php echo e(route('admin.market.comment.status', $comment->id)); ?>"
                                               type="checkbox" <?php if($comment->status === 1): ?>
                                                   checked
                                            <?php endif; ?>>
                                    </label>
                                </td>
                                <td class="width-8-rem text-left">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a href="<?php echo e(route('admin.market.comment.show', $comment->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-eye"></i> نمایش</a>

                                            <?php if($comment->approved == 1): ?>
                                                <a href="<?php echo e(route('admin.market.comment.approved', $comment->id)); ?>"
                                                   class="dropdown-item text-right" type="submit"><i class="fa fa-clock"></i> عدم
                                                    تایید</a>
                                            <?php else: ?>
                                                <a href="<?php echo e(route('admin.market.comment.approved', $comment->id)); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/comment/index.blade.php ENDPATH**/ ?>
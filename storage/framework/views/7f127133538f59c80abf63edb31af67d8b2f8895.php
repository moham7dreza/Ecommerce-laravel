        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <!-- logo start -->
                    <div class="logo"> <a href="it_home.html"><img src="<?php echo e(asset('assemble-assets/images/logos/it_logo.png')); ?>" alt="logo" /></a> </div>
                    <!-- logo end -->
                </div>
                <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="menu_side">
                        <div id="navbar_menu">
                            <ul class="first-ul">
                                <li> <a class="active" href="<?php echo e(route('customer.home')); ?>">Home</a>
                                    <ul>
...
<!-- end header -->
<?php /**PATH C:\CODEX\project-toplearn\resources\views/smart-assemble/layouts/header.blade.php ENDPATH**/ ?>
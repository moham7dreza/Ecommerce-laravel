                    ...
                    <section class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="case" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $case_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($case->id); ?>"  <?php if(old('case') == $case->id): ?> selected <?php endif; ?>><?php echo e($case->name); ?></option>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="cpu" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $cpu_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="motherboard" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $mb_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="ram" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $ram_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="psu" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $psu_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="case" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $hdd_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="ssd" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $ssd_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="gpu" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $gpu_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="cooler" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $cooler_category_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/admin/smart-assemble/system/components/create.blade.php ENDPATH**/ ?>
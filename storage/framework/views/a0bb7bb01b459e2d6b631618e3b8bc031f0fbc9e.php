                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <td><?php echo e($service->getParent()); ?></td>

                                        <td><?php echo e(jalaliDate($service->created_at)); ?></td>
                                        <td>
                                            <div class="row">
                                                <a href="<?php echo e(route('panel.service.edit', $service->id)); ?>" class="btn outlined c-main o-main fnt-xxs ml-1">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form action="<?php echo e(route('panel.service.change.status', $service->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                ...
                                                <form action="<?php echo e(route('panel.service.destroy', $service->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/panel/service/index.blade.php ENDPATH**/ ?>
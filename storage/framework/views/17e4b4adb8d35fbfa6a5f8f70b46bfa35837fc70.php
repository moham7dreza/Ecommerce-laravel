        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="<?php echo e(route('admin.market.color.create', $product->id)); ?>" class="btn btn-info btn-sm">ایجاد
                        رنگ جدید </a>
                        ...
                        <?php $__currentLoopData = $product->colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    <form class="d-inline"
                                          action="<?php echo e(route('admin.market.color.destroy', ['product' => $product->id , 'color' => $color->id] )); ?>"
                                          method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/product/color/index.blade.php ENDPATH**/ ?>
...
<div class="flex items-center">
    ...
    >
        ...
        >
            ...
            <span class="opacity-90 mr-1"><?php echo e(number_format($logs->total())); ?><?php if($hasMoreResults): ?>+<?php endif; ?> entries in</span>
            ...
            <span class="opacity-90"><?php echo e(number_format($totalLogsFound)); ?><?php if($hasMoreResults): ?>+<?php endif; ?> entries found. None selected</span>
            <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'log-viewer::components.checkmark','data' => ['class' => 'checkmark mr-2.5','checked' => $levelCount->selected]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\CODEX\techzilla\vendor\opcodesio\log-viewer\src/../resources/views/partials/log-list-level-buttons.blade.php ENDPATH**/ ?>
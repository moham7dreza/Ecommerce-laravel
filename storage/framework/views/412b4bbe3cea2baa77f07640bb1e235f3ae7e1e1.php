                                ...
                                <td class="width-8-rem text-left">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a href="<?php echo e(route('admin.market.order.show', $order->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-images"></i> مشاهده
                                                فاکتور</a>
                                            <a href="<?php echo e(route('admin.market.order.changeSendStatus', $order->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-list-ul"></i> تغییر
                                                وضعیت ارسال</a>
                                            <a href="<?php echo e(route('admin.market.order.changeOrderStatus', $order->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-edit"></i> تغییر وضعیت
                                                سفارش</a>
                                            <a href="<?php echo e(route('admin.market.order.cancelOrder', $order->id)); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/order/index.blade.php ENDPATH**/ ?>
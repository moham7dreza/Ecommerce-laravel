            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('adminto.post.store')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('title')); ?>" id="title" name="title" placeholder="عنوان مقاله را وارد کنید">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('time_to_read')); ?>" id="time_to_read" name="time_to_read"
...
unset($__errorArgs, $__bag); ?>" name="type">
                                                <?php $__currentLoopData = \App\Models\Content\Post::$types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($type); ?>" <?php if(old('type') == $type): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('summary')); ?>" id="summary" name="summary"
...
unset($__errorArgs, $__bag); ?>"
                                            id="body" name="body"
                                            placeholder="توضیحات اصلی مقاله را وارد کنید"><?php echo e(old('body')); ?></textarea>
...
<?php echo $__env->make('adminto.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/adminto/post/create.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('astro-assets/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('astro-assets/css/slick.css" type="text/css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('astro-assets/css/templatemo-style.css')); ?>">
    <!--
...
<video autoplay muted loop id="bg-video">
    <source src="<?php echo e(asset('astro-assets/video/gfp-astro-timelapse.mp4')); ?>" type="video/mp4">
</video>
                    ...
                    <nav class="navbar navbar-expand-lg" id="tm-nav">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-supported-content">
                            <ul class="navbar-nav mb-2 mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-no="2">Gallery</a>
                                    <div class="circle"></div>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-no="3">About</a>
                                    <div class="circle"></div>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-no="4">Contact</a>
                                    <div class="circle"></div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="page-width-1 page-left">
                    <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                        ...
                        <div class="intro-right">
                            <img src="<?php echo e(asset('astro-assets/img/home-img-1.jpg')); ?>" alt="Image" class="img-fluid intro-img-1">
                            <img src="<?php echo e(asset('astro-assets/img/home-img-2.jpg')); ?>" alt="Image" class="img-fluid intro-img-2">
                        </div>
                ...
                <div class="mx-auto position-relative gallery-container">
                    ...
                    <div class="mx-auto tm-border-top gallery-slider">
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-01.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                        ...
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-02.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-03.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-04.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-05.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-06.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-07.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-08.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
                        ...
                        <figure class="effect-julia item">
                            <img src="<?php echo e(asset('astro-assets/img/gallery-img-09.jpg')); ?>" alt="Image">
                            <figcaption>
                                <div>
                                    <p>Julia dances in the deep dark</p>
                                </div>
...
<script src="<?php echo e(asset('astro-assets/js/jquery-3.5.1.min.js')); ?>"></script>
<script src="<?php echo e(asset('astro-assets/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('astro-assets/js/slick.js')); ?>"></script>
<script src="<?php echo e(asset('astro-assets/js/templatemo-script.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\CODEX\techzilla\resources\views/single-pages/motion.blade.php ENDPATH**/ ?>
                                    ...
                                    <section class="header-cart-dropdown">
                                        ...
                                        <section
                                            ...
                                            <section class="">
                                                ...
                                                <section> <?php echo e(priceFormat($totalProductPrice - $totalDiscount)); ?>تومان
                                                </section>
                                            </section>
                                            <section class=""><a class="btn btn-danger btn-sm d-block"
                                                                 href="<?php echo e(route('customer.sales-process.cart')); ?>">ثبت
                                                    سفارش</a>
                                            </section>
                                        </section>
                                    </section>
        ...
        <section class="container-xxl ">
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-start position-relative">
                    ...
                    <section class="navbar-item"><a href="<?php echo e(route('digital-world.technology.index')); ?>">دنیای
                            دیجیتالی</a></section>

<?php $__env->startSection('head-tag'); ?>
    <title>
        ویرایش دسته بندی <?php echo e($postCategory->name); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="m-t-0 header-title">ویرایش دسته بندی <?php echo e($postCategory->name); ?></h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                <form class="form-horizontal" role="form" method="POST" id="form" enctype="multipart/form-data"
                                    action="<?php echo e(route('adminto.category.update', $postCategory->id)); ?>">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('name', $postCategory->name)); ?>" id="name" name="name">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 text-right">
                                            <input type="hidden" class="form-control form-control-sm"  name="tags" id="tags" value="<?php echo e(old('tags', $postCategory->tags)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="parent_id">
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($category->id); ?>"
                                                            <?php if(old('parent_id', $postCategory->parent_id) == $category->id): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            ><?php echo e(old('description', $postCategory->description)); ?></textarea>
...
<?php echo $__env->make('adminto.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/adminto/category/edit.blade.php ENDPATH**/ ?>
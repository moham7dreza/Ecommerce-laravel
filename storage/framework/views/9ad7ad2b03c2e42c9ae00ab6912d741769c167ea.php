...
<?php $__currentLoopData = $productsWithActiveAmazingSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <section class="col-md-3 p-0">
                <section class="product">
                    ...
                    <a class="product-link" href="<?php echo e(route('customer.market.product', $offer->product)); ?>">
                        <section class="product-image">
                            <img class="" src="<?php echo e(asset($offer->product->image['indexArray']['medium'])); ?>" alt="<?php echo e($offer->product->name); ?>">
                        </section>
                        <section class="product-colors"></section>
                        <section class="product-name"><h3><?php echo e($offer->product->name); ?></h3></section>
                        <section class="product-price-wrapper">
                            <section class="product-price"><?php echo e(priceFormat($offer->product->price)); ?> تومان</section>
                        </section>
                        <section class="product-colors">
                            <?php $__currentLoopData = $offer->product->colors()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('customer.layouts.filter-two-col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/customer/market/product/best-offers.blade.php ENDPATH**/ ?>
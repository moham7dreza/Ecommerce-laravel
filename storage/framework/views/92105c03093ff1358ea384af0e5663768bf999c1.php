...
<div class="min-h-full">
    ...
    <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.user.admin-user-advanced-table')->html();
} elseif ($_instance->childHasBeenRendered('6MlbQoP')) {
    $componentId = $_instance->getRenderedChildComponentId('6MlbQoP');
    $componentTag = $_instance->getRenderedChildComponentTagName('6MlbQoP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6MlbQoP');
} else {
    $response = \Livewire\Livewire::mount('admin.user.admin-user-advanced-table');
    $html = $response->html();
    $_instance->logRenderedChild('6MlbQoP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <!-- /End replace -->

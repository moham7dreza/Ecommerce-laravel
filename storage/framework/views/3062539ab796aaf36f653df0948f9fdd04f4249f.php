...
<!-- loader -->
<div class="bg_load"> <img class="loader_animation" src="<?php echo e(asset('assemble-assets/images/loaders/loader_1.png')); ?>" alt="#" /> </div>
<!-- end loader -->
...
<?php /**PATH C:\CODEX\project-toplearn\resources\views/smart-assemble/layouts/master.blade.php ENDPATH**/ ?>
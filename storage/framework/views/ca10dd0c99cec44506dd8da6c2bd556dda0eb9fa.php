                                    ...
                                    <select name="product_id" id="" class="form-control form-control-sm">
                                        ...
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($product->id); ?>"
                                                    <?php if(old('product_id') == $product->id): ?> selected <?php endif; ?>><?php echo e($product->name); ?></option>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/discount/amazing-create.blade.php ENDPATH**/ ?>
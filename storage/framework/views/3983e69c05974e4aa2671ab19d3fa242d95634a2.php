                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('adminto.user.store')); ?>">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('first_name')); ?>" id="first_name" name="first_name" placeholder="نام کاربر را وارد کنید">
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('last_name')); ?>" id="last_name" name="last_name" placeholder="نام خانوادگی کاربر را وارد کنید">
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('email')); ?>" id="email" name="email" placeholder="ایمیل کاربر را وارد کنید">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label" for="password_confirmation">تایید کلمه عبور</label>
                                        <div class="col-sm-10">
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('password_confirmation')); ?>" id="password_confirmation" name="password_confirmation"
                                                   placeholder="رمز عبور کاربر را وارد کنید">
...
<?php echo $__env->make('adminto.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/adminto/user/create.blade.php ENDPATH**/ ?>
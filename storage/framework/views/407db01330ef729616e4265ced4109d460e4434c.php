                            ...
                            <div class="position-relative">
                                <div
                                    class="position-absolute mt-2 p-1 entry-meta meta-1 font-x-small color-grey float-right text-uppercase">
                                                <span class="post-by">
                                                    <a href="<?php echo e(route('digital-world.posts.author.followers', $author)); ?>">دنبال کننده ها : </a><strong id="followers-count"><?php echo e($author->followersCount()); ?></strong>
                                                </span>
                                    <span class="post-by">
                                    ...
                                    <span
                                        class="post-on">تعداد لایک های زده شده روی پست های نویسنده : <strong id="likes-count"><?php echo e($author->likesCount()); ?></strong></span>
                                    <span

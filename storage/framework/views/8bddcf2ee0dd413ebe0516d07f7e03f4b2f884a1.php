                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        ...
                        <section class="col-md-9 mb-3">
                            <form action="<?php echo e(route('smart.assemble.add-system-to-cart', $system)); ?>" id="add-to-cart" method="post"
                                ...
                                <section class="content-header pt-3 pb-2">
                                    ...
                                    ?>
                                        <?php $__currentLoopData = $system_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $system_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <section class="cart-item d-md-flex py-3">
                                        <section class="cart-img align-self-start flex-shrink-1">
                                            <img src="<?php echo e(asset($system_item->product->image['indexArray']['medium'])); ?>"
                                                 alt="">
                                        </section>
                                        <section class="align-self-start w-100">
                                            <p class="fw-bold"><?php echo e($system_item->product->name); ?></p>
                                            <p>
                                                <?php if(!empty($system_item->color)): ?>
                                                    <span style="background-color: <?php echo e($cartItem->color->color); ?>;"
                                                          class="cart-product-selected-color me-1"></span>
                                                    <span> <?php echo e($system_item->color->color_name); ?></span>
                                                <?php else: ?>
                                            ...
                                            <section>
                                                <section class="cart-product-number d-inline-block ">
                                                    ...
                                                    <input class="number" name="number[<?php echo e($system_item->id); ?>]"
                                                           type="number"
                                                ...
                                                <a class="text-decoration-none ms-4 cart-delete"
                                                   href="<?php echo e(route('customer.sales-process.remove-from-cart', $system_item)); ?>"><i
                                                        class="fa fa-trash-alt"></i> حذف از سبد</a>
                                            </section>
                                        </section>
                                        <section class="align-self-end flex-shrink-1">
                                            <?php if(!empty($system_item->product->activeAmazingSales())): ?>
                                                <section class="cart-item-discount text-danger text-nowrap mb-1">
                                                    تخفیف <?php echo e(100); ?></section>
                                            <?php endif; ?>
                                            <section
                                                class="text-nowrap fw-bold">
                                                <h6><?php echo e(priceFormat($system_item->product->price) . ' تومان '); ?> </h6>
                                            </section>
                                        </section>
                                    </section>
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                <section class="d-flex align-items-center font-weight-bold">
                                    <p class="text-dark"><?php echo e($system->name); ?></p>
                                    </section>
                                <section class="border-bottom border-danger mb-3"></section>
                                <section class="d-flex justify-content-between align-items-center">
                                    <p class="text-muted">قیمت سیستم</p>
                                    <p class="text-muted"><span id="product_price" data-product-original-price=<?php echo e(0); ?>><?php echo e(priceFormat($system->system_price)); ?></span> <span class="small">تومان</span></p>
                                </section>
                                ...
                                <section class="d-flex justify-content-end align-items-center">
                                    <p class="fw-bolder"><span  id="final-price"><?php echo e(priceFormat($system->system_price)); ?></span> <span class="small">تومان</span></p>
                                </section>

                                <section class="">
                                    <?php if($system->system_marketable_number > 0): ?>
...
<?php echo $__env->make('customer.layouts.master-one-col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/smart-assemble/build.blade.php ENDPATH**/ ?>
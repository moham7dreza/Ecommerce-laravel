    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="<?php echo e(route('admin.market.product.store')); ?>" method="post" enctype="multipart/form-data"
                          id="form">
                        <?php echo csrf_field(); ?>
                        <section class="row">
                                    ...
                                    <select name="category_id" id="" class="form-control form-control-sm">
                                        ...
                                        <?php $__currentLoopData = $productCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($productCategory->id); ?>"
                                                    <?php if(old('category_id') == $productCategory->id): ?> selected <?php endif; ?>><?php echo e($productCategory->name); ?></option>
                                    ...
                                    <select name="brand_id" id="" class="form-control form-control-sm">
                                        ...
                                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($brand->id); ?>"
                                                    <?php if(old('brand_id') == $brand->id): ?> selected <?php endif; ?>><?php echo e($brand->original_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="">وزن</label>
                                    <input type="text" name="weight" value="<?php echo e(old('weight')); ?>"
                                           class="form-control form-control-sm">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="">عرض</label>
                                    <input type="text" name="width" value="<?php echo e(old('width')); ?>"
                                           class="form-control form-control-sm">
                                </div>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="introduction" id="introduction" name="introduction"
                                              class="form-control form-control-sm"
                                              rows="6"><?php echo e(old('introduction')); ?></textarea>
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/product/create.blade.php ENDPATH**/ ?>
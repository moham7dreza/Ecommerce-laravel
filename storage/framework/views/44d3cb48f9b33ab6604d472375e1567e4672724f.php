...
<script src="<?php echo e(asset('adminto-assets/libs/jquery-knob/jquery.knob.min.js')); ?>"></script>
<script src="<?php echo e(asset('adminto-assets/libs/morris-js/morris.min.js')); ?>"></script>

                        ...
                        <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    <a href="<?php echo e(route('admin.ticket.show', $ticket->id)); ?>" class="btn btn-info btn-sm"><i
                                            class="fa fa-eye"></i> مشاهده</a>
                                    <a href="<?php echo e(route('admin.ticket.change', $ticket->id)); ?>"
                                       class="btn btn-warning btn-sm"><i
                                            class="fa fa-check"></i> <?php echo e($ticket->status == 1 ? 'باز کردن' : 'بستن'); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/ticket/index.blade.php ENDPATH**/ ?>
                            ...
                            <section class="modal-content">
                                ...
                                <section class="modal-body">
                                    <form class="row" method="post"
                                          action="<?php echo e(route('customer.profile.update.info', $user)); ?>">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <section class="col-6 mb-2">
                                            ...
                                            <input value="<?php echo e($user->email  ?? $user->email); ?>"
                                        ...
                                        <section class="col-6 mb-2">
                                            <label for="mobile" class="form-label mb-1">شماره
                                                موبایل</label>
                                            <input value="<?php echo e($user->mobile ?? $user->mobile); ?>"
                                        ...
                                        <section class="col-6 mb-2">
                                            ...
                                            <input value="<?php echo e($user->national_code  ?? $user->national_code); ?>"

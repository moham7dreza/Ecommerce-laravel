    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="<?php echo e(route('admin.user.customer.update', $user->id)); ?>" method="post"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo e(asset($user->profile_photo_path)); ?>" alt="" width="100" height="50"
                                         class="mt-3">
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/user/customer/edit.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price_increase" value="<?php echo e(old('price_increase')); ?>"
                                           class="form-control form-control-sm">
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/product/guarantee/create.blade.php ENDPATH**/ ?>
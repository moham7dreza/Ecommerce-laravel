  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="<?php echo e(route('admin.smart-assemble.config.store')); ?>" method="post" enctype="multipart/form-data" id="form">
                    <?php echo csrf_field(); ?>
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="system_gen_id" id="" class="form-control form-control-sm">
                                    <?php $__currentLoopData = $cpus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cpu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cpu->id); ?>"  <?php if(old('system_gen_id') == $cpu->id): ?> selected <?php endif; ?>><?php echo e($cpu->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_price_from" value="<?php echo e(old('start_price_from')); ?>" class="form-control form-control-sm">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="brief" value="<?php echo e(old('brief')); ?>" class="form-control form-control-sm">
                            </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/admin/smart-assemble/config/create.blade.php ENDPATH**/ ?>
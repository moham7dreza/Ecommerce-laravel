                    ...
                    <section class="row mt-4">
                                    ...
                                    <section class="product-gallery-thumbs">
                                        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <img class="product-gallery-thumb"
                                                 src="<?php echo e(asset($image['indexArray']['medium'])); ?>"
                                                 alt="<?php echo e(asset($image['indexArray']['medium']) . '-' . ($key + 1)); ?>"
                                                 data-input="<?php echo e(asset($image['indexArray']['medium'])); ?>">
                        ...
                        <section class="col-md-5">
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <form id="add_to_cart"
                                      action="<?php echo e(route('customer.sales-process.add-to-cart', $product)); ?>" method="post"
                                      class="product-info">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <?php if($colors->count() != 0): ?>
                                        <p><span>رنگ انتخاب شده : <span
                                                    id="selected_color_name"> <?php echo e($colors->first()->color_name); ?></span></span>
                                        </p>
                                        <p>
                                            <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <label for="<?php echo e('color_' . $color->id); ?>"
                                                       style="background-color: <?php echo e($color->color ?? '#ffffff'); ?>;"
                                                       class="product-info-colors me-1" data-bs-toggle="tooltip"
                                                       data-bs-placement="bottom"
                                                       title="<?php echo e($color->color_name); ?>"></label>

                                                <input class="d-none" type="radio" name="color"
                                                       id="<?php echo e('color_' . $color->id); ?>" value="<?php echo e($color->id); ?>"
                                                       data-color-name="<?php echo e($color->color_name); ?>"
                                                       data-color-price=<?php echo e($color->price_increase); ?> <?php if($key == 0): ?> checked <?php endif; ?>>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <p><i class="fa fa-shield-alt cart-product-selected-warranty me-1"></i>
                                            ...
                                            <select name="guarantee" id="guarantee" class="p-1">
                                                <?php $__currentLoopData = $guarantees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $guarantee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($guarantee->id); ?>"
                                                            data-guarantee-price=<?php echo e($guarantee->price_increase); ?>  <?php if($key == 0): ?> selected <?php endif; ?>><?php echo e($guarantee->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </p>
                                    <?php endif; ?>
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-muted"><span id="product_price"
                                                                data-product-original-price=<?php echo e($product->price); ?>><?php echo e(priceFormat($product->price)); ?></span>
                                ...
                                <?php if(!empty($amazingSale)): ?>
                                    <section class="d-flex justify-content-between align-items-center">
                                        ...
                                        <p class="text-danger fw-bolder" id="product-discount-price"
                                           data-product-discount-price="<?php echo e(($product->price * ($amazingSale->percentage / 100) )); ?>"><?php echo e(priceFormat($product->price * ($amazingSale->percentage / 100) )); ?>
                                ...
                                <section class="">
                                    ...
                                    <?php else: ?>
                                        <button id="next-level" class="btn btn-secondary disabled d-block">محصول نا
                                            موجود میباشد
                                        </button>
                                    <?php endif; ?>
                                </section>
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link"
                                                   href="<?php echo e(route('customer.market.product', $relatedProduct)); ?>">
                                        ...
                                        <section class="modal-dialog">
                                            <section class="modal-content">
                                                ...
                                                <?php if(auth()->guard()->guest()): ?>
                                                    <section class="modal-body">
                                                        ...
                                                        <p>لینک ثبت نام و یا ورود
                                                            <a href="<?php echo e(route('auth.customer.login-register-form')); ?>">کلیک
                                                                کنید</a>
                                                        </p>
                                                    </section>
                                                <?php endif; ?>
                                                <?php if(auth()->guard()->check()): ?>
                                                    <section class="modal-body">
                                                        <form class="row"
                                                              action="<?php echo e(route('customer.market.add-comment', $product)); ?>"
                                                              method="post">
                                                            <?php echo csrf_field(); ?>
                                ...
                                <?php $__currentLoopData = $product->activeComments(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activeComment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <section class="product-comment">
                                        <section class="product-comment-header d-flex justify-content-start">
                                            <section
                                                class="product-comment-date"><?php echo e(jalaliDate($activeComment->created_at)); ?></section>
                                            <?php
                                        ...
                                        <section
                                            class="product-comment-body <?php if($activeComment->answers()->count() > 0): ?> border-bottom  <?php endif; ?>">
                                        ...
                                        <?php $__currentLoopData = $activeComment->answers()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commentAnswer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <section class="product-comment">
                                                <section class="product-comment-header d-flex justify-content-start">
                                                    <section
                                                        class="product-comment-date"><?php echo e(jalaliDate($commentAnswer->created_at)); ?></section>
                                                    <?php
                                                ...
                                                <section
                                                    class="product-comment-body <?php if($commentAnswer->answers()->count() > 0): ?> border-bottom <?php endif; ?>">

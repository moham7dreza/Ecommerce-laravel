        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="<?php echo e(route('admin.market.product.create')); ?>" class="btn btn-info btn-sm">ایجاد کالای
                        جدید </a>
                    ...
                    <table class="table table-striped table-hover h-150px">
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img
                                        src="<?php echo e(asset($product->image['indexArray'][$product->image['currentImage']] )); ?>"
                                ...
                                <td class="width-8-rem text-left">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a href="<?php echo e(route('admin.market.gallery.index', $product->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-images"></i> گالری</a>
                                            <a href="<?php echo e(route('admin.market.color.index', $product->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-images"></i> مدیریت رنگ
                                                ها</a>
                                            <a href="<?php echo e(route('admin.market.guarantee.index', $product->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-shield-alt"></i> گارانتی</a>
                                            <a href="<?php echo e(route('admin.market.product.edit', $product->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-edit"></i> ویرایش</a>
                                            <form class="d-inline"
                                                  action="<?php echo e(route('admin.market.product.destroy', $product->id)); ?>"
                                                  method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/product/index.blade.php ENDPATH**/ ?>
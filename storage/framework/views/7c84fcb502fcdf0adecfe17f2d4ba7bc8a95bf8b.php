                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input id="<?php echo e($banner->id); ?>" onchange="changeStatus(<?php echo e($banner->id); ?>)"
                                               data-url="<?php echo e(route('admin.content.banner.status', $banner->id)); ?>"
                                               type="checkbox" <?php if($banner->status === 1): ?>
                                                   checked
                                            <?php endif; ?>>
                                    </label>
                                </td>
                                ...
                                <td class="width-16-rem text-left   ">
                                    ...
                                    <form class="d-inline"
                                          action="<?php echo e(route('admin.content.banner.destroy', $banner->id)); ?>"
                                          method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/content/banner/index.blade.php ENDPATH**/ ?>
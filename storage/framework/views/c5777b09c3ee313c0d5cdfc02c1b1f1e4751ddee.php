    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    <form action="<?php echo e(route('admin.smart-assemble.menu.store')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <section class="row">
                                    ...
                                    <select name="parent_id" id="" class="form-control form-control-sm">
                                        ...
                                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <option value="<?php echo e($menu->id); ?>"
                                                    <?php if(old('parent_id') == $menu->id): ?> selected <?php endif; ?>><?php echo e($menu->name); ?></option>
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <select name="show_in_menu" class="form-control form-control-sm" id="show_in_menu">
                                        <option value="0"
                                                <?php if(old('show_in_menu') == 0): ?> selected <?php endif; ?>>
                                            غیرفعال
                                        </option>
                                        <option value="1"
                                                <?php if(old('show_in_menu') == 1): ?> selected <?php endif; ?>>فعال
                                        </option>
                                    </select>
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/admin/smart-assemble/menu/create.blade.php ENDPATH**/ ?>
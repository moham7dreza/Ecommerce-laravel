            ...
            <div class="row">
                <div class="col-lg-2 col-md-3">
                    <div class="header-logo d-none d-lg-block">
                        <a href="<?php echo e(route('digital-world.livewire.home')); ?>">
                            <img class="logo-img d-inline" src="<?php echo e(asset('news-viral-assets/imgs/logo.svg')); ?>" alt="<?php echo e($setting->title); ?>">
                        </a>
                    </div>
                    ...
                    <div class="logo-mobile d-block d-md-none">
                        <a href="<?php echo e(route('digital-world.livewire.home')); ?>">
                            <img class="logo-img d-inline" src="<?php echo e(asset('news-viral-assets/imgs/favicon.svg')); ?>" alt="<?php echo e($setting->title); ?>">
                        </a>
                    </div>
                </div>
                <div class="col-lg-10 col-md-9 main-header-navigation">
                    <div class="main-nav text-right float-lg-right float-md-left">
                        <ul class="mobi-menu d-none menu-3-columns" id="navigation">
                            <li class="cat-item cat-item-2"><a href="<?php echo e(route('digital-world.livewire.home')); ?>">صفحه اصلی</a></li>
                            <li class="cat-item cat-item-3"><a href="<?php echo e(route('digital-world.livewire.post.home')); ?>">پست ها</a></li>
                            <li class="cat-item cat-item-4"><a href="<?php echo e(route('digital-world.livewire.author.home')); ?>">نویسنده ها</a></li>
                        ...
                        <nav>
                            <ul class="main-menu d-none d-lg-inline">
                                ...
                                <li>
                                    <a href="<?php echo e(route('digital-world.livewire.post.home')); ?>">
                                        پست ها
                                    </a>
                                </li>
                                <li>
                                        ...
                                        <?php $__currentLoopData = $categories->chunk(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <ul class="col-md-2">
                                                <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><a href="<?php echo e(route('digital-world.livewire.category.posts', $category)); ?>"><?php echo e($category->name); ?></a></li>
...
<?php /**PATH C:\CODEX\techzilla\resources\views/livewire/digital-world/layouts/header.blade.php ENDPATH**/ ?>
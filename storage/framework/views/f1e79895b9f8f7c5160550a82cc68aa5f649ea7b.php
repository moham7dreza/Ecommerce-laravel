                        ...
                        <section class="header-cart d-inline ps-3 border-start position-relative">
                            ...
                            <section class="header-cart-dropdown">
                                ...
                                <section class="header-cart-dropdown-footer border-top d-flex justify-content-between align-items-center p-2">
                                    ...
                                    <section class=""><a class="btn btn-danger btn-sm d-block" href="<?php echo e(route('customer.sales-process.cart')); ?>">ثبت سفارش</a></section>
                                </section>
                            </section>
                        </section>
                        <?php endif; ?>
            ...
            <section class="container-xxl ">
                <nav class="">
                    <section class="d-none d-md-flex justify-content-md-start position-relative">
                        ...
                        <section class="navbar-item"><a href="<?php echo e(route('customer.product.filter')); ?>">فیلتر</a></section>
                    ...
                    <section class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="z-index: 9999999;">
                        <section class="offcanvas-header">
                            <h5 class="offcanvas-title" id="offcanvasExampleLabel"><a class="text-decoration-none" href="index.html"><img src="<?php echo e(asset('customer-assets/images/logo/8.png')); ?>" alt="logo"></a></h5>
...
<?php /**PATH C:\CODEX\1 - laravel-shop-project\resources\views/customer/layouts/header.blade.php ENDPATH**/ ?>
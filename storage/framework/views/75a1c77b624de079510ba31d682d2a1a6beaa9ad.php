    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="<?php echo e(route('admin.smart-assemble.category.create')); ?>" class="btn btn-info btn-sm">ایجاد دسته بندی</a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($systemCategory->parent_id ? $systemCategory->parent->name : 'دسته اصلی'); ?></td>
                            <td><?php echo e($systemCategory->brief); ?></td>


                            <td>
                                <img src="<?php echo e(asset($systemCategory->image['indexArray'][$systemCategory->image['currentImage']] )); ?>" alt="" width="100" height="50">
                            </td>

                            <td>
                                <label>
                                    <input id="<?php echo e($systemCategory->id); ?>" onchange="changeStatus(<?php echo e($systemCategory->id); ?>)" data-url="<?php echo e(route('admin.smart-assemble.category.status', $systemCategory->id)); ?>" type="checkbox" <?php if($systemCategory->status === 1): ?>
                                        checked
                                        <?php endif; ?>>
                                </label>
                            </td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\1 - laravel-shop-project\resources\views/admin/smart-assemble/category/index.blade.php ENDPATH**/ ?>
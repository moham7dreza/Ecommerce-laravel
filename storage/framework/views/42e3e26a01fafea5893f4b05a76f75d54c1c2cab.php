    ...
    <div class="album py-5 bg-light">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <p class="lead text-center text-danger">نسل پردازنده سیستم موردنظر خود را انتخاب کنید.</p>
            </div>
        </div>
    </div>
    <div class="album py-5 bg-light">
            ...
            <div class="row">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item font-size-12 active" aria-current="page"><?php echo e($systemType->name); ?></li>
                    </ol>
                </nav>
                <!-- end breadcrumb -->
            </div>
...
<?php echo $__env->make('customer.layouts.master-one-col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/smart-assemble/cpu.blade.php ENDPATH**/ ?>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="marketable_number"
                                           value="<?php echo e(old('marketable_number', $product->marketable_number)); ?>"
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sold_number"
                                           value="<?php echo e(old('sold_number', $product->sold_number)); ?>"
                                           class="form-control form-control-sm">
                                </div>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="frozen_number"
                                           value="<?php echo e(old('frozen_number', $product->frozen_number)); ?>"
                                           class="form-control form-control-sm">
                                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/market/store/edit.blade.php ENDPATH**/ ?>
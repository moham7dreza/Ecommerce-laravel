                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(\Illuminate\Support\Str::limit($faq->question)); ?></td>
                                <td><?php echo \Illuminate\Support\Str::limit($faq->answer); ?></td>
                                <td>
                                    <label>
                                        <input id="<?php echo e($faq->id); ?>" onchange="changeStatus(<?php echo e($faq->id); ?>)"
                                               data-url="<?php echo e(route('admin.content.faq.status', $faq->id)); ?>"
                                               type="checkbox" <?php if($faq->status === 1): ?>
                                                   checked
                                            <?php endif; ?>>
                                    </label>
                                </td>
                                <td class="width-8-rem text-left">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <a href="<?php echo e(route('admin.content.faq.edit', $faq->id)); ?>"
                                               class="dropdown-item text-right"><i class="fa fa-edit"></i> ویرایش</a>
                                            <form class="d-inline"
                                                  action="<?php echo e(route('admin.content.faq.destroy', $faq->id)); ?>"
                                                  method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/admin/content/faq/index.blade.php ENDPATH**/ ?>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(priceFormat($system->system_price) .' تومان'); ?></td>
                            ...
                            <td class="width-8-rem text-left">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <?php endif; ?>
                                            <a href="<?php echo e(route('admin.smart-assemble.system.gallery.index', $system)); ?>" class="dropdown-item text-right"><i class="fa fa-images"></i> گالری</a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\mars-shop\resources\views/admin/smart-assemble/system/index.blade.php ENDPATH**/ ?>
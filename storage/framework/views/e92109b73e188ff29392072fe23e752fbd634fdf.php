                            ...
                            <tbody>
                                <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="row">
                                                <form action="<?php echo e(route('panel.market.comment.change.status', $comment->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                                    <button type="submit" class="btn btn-<?php echo e($comment->btnCssStatus()); ?> ml-1">
                                                        <i class="fas fa-minus-circle"></i>
                                                    </button>
                                                </form>

                                                <form action="<?php echo e(route('panel.market.comment.change.approve', $comment->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                                    <button type="submit" class="btn btn-<?php echo e($comment->btnCssApprove()); ?> ml-1">
                                                        <i class="fas fa-plus"></i>
                                                    </button>
                                                </form>

                                                <form action="<?php echo e(route('panel.market.comment.destroy', $comment->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CODEX\techzilla\resources\views/panel/market/comment/index.blade.php ENDPATH**/ ?>
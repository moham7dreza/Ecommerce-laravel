        ...
        <ul class="font-small text-muted">
            <?php $__currentLoopData = $activeCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="cat-item cat-item-2">
                    <a href="<?php echo e(route('digital-world.livewire.category.posts', $category)); ?>"><?php echo e($category->name); ?></a>
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
    </div>
</div>
<?php /**PATH C:\CODEX\techzilla\resources\views/livewire/digital-world/partials/right-sidebar.blade.php ENDPATH**/ ?>
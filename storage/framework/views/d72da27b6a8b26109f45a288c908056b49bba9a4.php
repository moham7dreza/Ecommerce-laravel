                ...
                <div class="col-lg-10 col-md-9 main-header-navigation">
                    <div class="main-nav text-right float-lg-right float-md-left">
                        <ul class="mobi-menu d-none menu-3-columns" id="navigation">
                            <li class="cat-item cat-item-2"><a href="<?php echo e(route('digital-world.home')); ?>">صفحه اصلی</a></li>
                            <li class="cat-item cat-item-3"><a href="<?php echo e(route('digital-world.posts.all')); ?>">پست ها</a></li>
                            <li class="cat-item cat-item-4"><a href="<?php echo e(route('digital-world.posts.authors')); ?>">نویسنده ها</a></li>

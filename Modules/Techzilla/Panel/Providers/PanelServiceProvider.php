...
namespace Modules\Techzilla\Panel\Providers;

use Illuminate\Support\Facades\Gate;
use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use Modules\Techzilla\Panel\Policies\PanelPolicy;
...
class PanelServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    public string $namespace = 'Modules\Techzilla\Panel\Http\Controllers';

...
class BasicBot
{
    ...
    public function SendDocIK($chat_id, $file_id, $caption = null, $IK)
    {
        $this->apiRequest('sendDocument', [
            'chat_id' => $chat_id,
            'document' => $file_id,
    ...
    public function SendVideoIK($chat_id, $file_id, $caption = null, $IK)
    {
        $this->apiRequest('sendVideo', [
            'chat_id' => $chat_id,
            'video' => $file_id,
    ...
    public function SendAudioIK($chat_id, $file_id, $caption = null, $IK)
    {
        $this->apiRequest('sendAudio', [
            'chat_id' => $chat_id,
            'audio' => $file_id,
    ...
    public function SendPhotofid($id, $fileid, $caption)
    {
        $this->apiRequestP('sendPhoto', ['chat_id' => $id,
            'photo' => $fileid,
            'caption' => $caption
    ...
    //khabari
    public function SendPCIK($id, $IK, $fileid, $caption)
    {
    ...
    //khabari
    public function SendPIK($id, $IK, $fileid)
    {
        $this->apiRequest('sendphoto', [
            'chat_id' => $id,
            'photo' => $fileid,
...
class MyTelegramBot extends BasicBot
{
...
//SendMessage($id,"select record ... fname : ".$row["firstname"]."--".$row["lastname"]."--".$row["mobile"]."--".$row["city"]);
    ...
    public function ExecuteThisSql($sql1, $sql2)
    {
        $conn = $this->CreateConn();
        // Check connection
        if (!$conn) {
    ...
    */
    ...
    //khabari
    public function InsertSomeCols($id, $colsname = array(), $values, $table, $where, $equal)
    {
        $conn = $this->CreateConn();
        // Check connection
        if (!$conn) {
...
class TwitterBot extends MyTelegramBot
{
